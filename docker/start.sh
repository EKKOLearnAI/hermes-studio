...
# Set hermes default working directory to /root/workspace
echo "[start] Setting hermes cwd to /root/workspace..."
/opt/hermes/.venv/bin/hermes config set messaging.cwd /root/workspace 2>/dev/null || true
/opt/hermes/.venv/bin/hermes config set terminal.cwd /root/workspace 2>/dev/null || true
