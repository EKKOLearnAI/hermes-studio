...
- Follow-up hardening uses a persisted monotonic Room sequence cursor across pruning, waits for incompatible runs to stop, persists aborted workspace evidence, isolates Group Chat from inherited external MCP/plugins, and clears stale approval waiters.
