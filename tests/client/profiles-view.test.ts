...
vi.mock('@/components/hermes/action-fabric/ActionFabricPanel.vue', () => ({ default: defineComponent({ template: '<div data-test="action-fabric-panel" />' }) }))
...
describe('ProfilesView', () => {
  it('shows Runtime Profiles, Assistant Roles, and Action Fabric tabs while preserving runtime profile controls', () => {
    ...
    expect(wrapper.text()).toContain('Action Fabric')
    ...
    expect(wrapper.find('[data-test="action-fabric-panel"]').exists()).toBe(true)
