...
const zh: Messages = {
  ...
  metadata: '决策与升级元数据', decisionAuthority: '决策权限（JSON）', spendingLimits: '消费限额（JSON）', escalationRules: '升级规则（JSON 数组）', recipes: '上下文配方', recipeLimitsNotice: '配方限额修改仅作用于本次预览；当前 Phase 2 API 将配方作为只读配置公开。', perSection: '每分区条数', totalCharacters: '总字符数',
