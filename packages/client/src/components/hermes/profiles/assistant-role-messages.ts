...
const en = {
  ...
  phase3Warning: 'Capability permissions are enforced by Action Fabric. External executors are not available yet.',
...
const zh: Messages = {
  ...
  edit: '编辑', clone: '克隆', delete: '删除', preview: '预览上下文', staleMapping: '映射的运行时身份不存在。请先选择有效身份再使用此角色。', phase3Warning: '能力权限现由 Action Fabric 强制执行；外部执行器尚未开放。',
