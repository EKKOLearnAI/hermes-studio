...
const en = {
  ...
  phase3Warning: 'Action Fabric enforces capability permissions for internal and external executors. An allow declaration never bypasses policy, target authorization, emergency control, or verification.',
...
const zh: Messages = {
  ...
  edit: '编辑', clone: '克隆', delete: '删除', preview: '预览上下文', staleMapping: '映射的运行时身份不存在。请先选择有效身份再使用此角色。', phase3Warning: 'Action Fabric 对内部与外部执行器统一强制能力权限；允许声明不会绕过策略、目标授权、紧急控制或验证。',
