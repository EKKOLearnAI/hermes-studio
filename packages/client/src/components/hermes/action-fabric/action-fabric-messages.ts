...
const en = {
  actionFabric: 'Action Fabric', banner: 'Only simulator and reversible internal executors are available in this phase.',
...
const zh: Messages = {
  actionFabric: '行动编排', banner: '当前阶段仅提供模拟器和可逆的内部执行器。', actionCenter: '行动中心', capabilities: '能力与授权', emergencyStop: '紧急停止',
  ...
  executor: '执行器', executors: '执行器注册表', risk: '风险', environment: '环境', health: '健康', idempotency: '幂等性', reversibleLabel: '可逆', verification: '验证', enabled: '已启用', disabled: '已停用', roleAuthorization: '角色授权声明', allowDeclaration: '允许声明', denyDeclaration: '拒绝声明', notDeclared: '未声明', noCapabilities: '服务端未返回能力。', noExecutors: '服务端未返回执行器。', noRoles: '服务端未返回助手角色。',
