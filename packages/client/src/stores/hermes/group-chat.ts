...
import {
    ...
    deleteRoom as deleteRoomApi, leaveRoom as leaveRoomApi,
    clearRoomContext,
...
const currentUserAvatar = ref('')
    ...
    async function leaveCurrentRoom() {
        ...
        try { await leaveRoomApi(currentRoomId.value); rooms.value = rooms.value.filter(r => r.id !== currentRoomId.value); currentRoomId.value = null } catch (e) { console.error(e) }
    }
