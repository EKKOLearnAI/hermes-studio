...
import { ref } from 'vue';
import { checkHealth, fetchAvailableModels, updateDefaultModel, triggerUpdate } from '@/api/hermes/system';
...
export const useAppStore = defineStore('app', () => {
    ...
    async function checkConnection() {
        try {
            ...
            if (res.webui_version)
                serverVersion.value = res.webui_version;
            if (res.webui_latest)
                latestVersion.value = res.webui_latest;
    ...
    async function switchModel(modelId, providerOverride) {
        try {
