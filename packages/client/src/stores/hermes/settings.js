...
export const useSettingsStore = defineStore('settings', () => {
    ...
    async function saveSection(section, values) {
        ...
        try {
            ...
            switch (section) {
                case 'display':
                    display.value = { ...display.value, ...values };
                    break;
                case 'agent':
                    agent.value = { ...agent.value, ...values };
                    break;
                case 'memory':
                    memory.value = { ...memory.value, ...values };
                    break;
                case 'session_reset':
                    sessionReset.value = { ...sessionReset.value, ...values };
                    break;
                case 'privacy':
                    privacy.value = { ...privacy.value, ...values };
                    break;
                case 'telegram':
                    telegram.value = { ...telegram.value, ...values };
                    break;
                case 'discord':
                    discord.value = { ...discord.value, ...values };
                    break;
                case 'slack':
                    slack.value = { ...slack.value, ...values };
                    break;
                case 'whatsapp':
                    whatsapp.value = { ...whatsapp.value, ...values };
                    break;
                case 'matrix':
                    matrix.value = { ...matrix.value, ...values };
                    break;
                case 'wechat':
                case 'wecom':
                    wecom.value = { ...wecom.value, ...values };
                    break;
                case 'feishu':
                    feishu.value = { ...feishu.value, ...values };
                    break;
                case 'dingtalk':
                    dingtalk.value = { ...dingtalk.value, ...values };
                    break;
                case 'weixin':
                    weixin.value = { ...weixin.value, ...values };
                    break;
                case 'platforms': {
