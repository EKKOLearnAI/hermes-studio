export default {
  ...
  chat: {
    ...
    suggestTitleFailed: 'Titelvorschlag fehlgeschlagen',
    suggestTitleReady: 'Titelvorschlag eingefügt',
    suggestTitleUnchanged: 'Der vorgeschlagene Titel ist bereits aktuell',
