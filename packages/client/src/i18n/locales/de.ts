export default {
  ...
  runtimeVersions: {
    ...
    runtimeDirectoryHint: 'Die aktuelle Runtime wird beim nächsten Neustart vor dem Start lokaler Dienste kopiert und geprüft. Die alte Kopie bleibt erhalten.',
    ...
    runtimeMigrationFailed: 'Runtime-Migration fehlgeschlagen; die vorherige Runtime wird weiter verwendet',
    active: 'Aktiv',
...
jobTriggered: 'Job ausgelost',
  ...
  changelog: {
    ...
    new_0_6_31_12: 'Die Versionsverwaltung kann den Runtime-Speicher jetzt verlagern; die Migration läuft beim nächsten Neustart vor den Diensten und behält die alte Kopie als Rückfalloption (#2134)',
