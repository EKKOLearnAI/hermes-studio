...
jobTriggered: 'Job ausgelost',
  ...
  profiles: {
    ...
    thinkingAnimation: {
      title: 'Benutzerdefinierte Denk-Animation',
      customize: 'Animation',
      upload: 'Datei hochladen',
      save: 'Speichern',
      reset: 'Standard verwenden',
      hint: 'GIF, WebP, MP4 oder WebM. Max. 5 MB.',
      invalidType: 'Bitte GIF, WebP, MP4, WebM oder Bilddatei w\u00e4hlen',
      tooLarge: 'Animationsdatei darf max. 5 MB sein',
      saveSuccess: 'Denk-Animation gespeichert',
      saveFailed: 'Speichern fehlgeschlagen',
      resetSuccess: 'Standard-Animation wiederhergestellt',
      resetFailed: 'Wiederherstellung fehlgeschlagen',
      urlPlaceholder: 'URL einf\u00fcgen oder leer f\u00fcr Standard',
      noPreview: 'Keine benutzerdefinierte Animation',
      enableThinking: 'Denk-Animation aktivieren',
      delete: 'Animation l\u00f6schen',
      maxReached: 'Maximum von {max} Animationen erreicht',
      savedItems: '{count} Animation(en) gespeichert',
    },
    runtime: {
