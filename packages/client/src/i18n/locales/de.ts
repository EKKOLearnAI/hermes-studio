...
jobTriggered: 'Job ausgelost',
  ...
  settings: {
    ...
    voice: {
      ...
      clearStoredKey: 'Gespeicherten Key löschen',
      storedServerKey: 'Gespeicherter Server-Key: {value}',
      secretPendingSave: 'wird beim Speichern aktualisiert',
      storedOnServer: 'Auf dem Server gespeichert',
      saveTtsSettings: 'TTS-Einstellungen speichern',
      webspeechSettingsSaved: 'WebSpeech-Einstellungen lokal gespeichert.',
      ttsSettingsSaved: 'TTS-Einstellungen auf dem Server gespeichert.',
      ttsSettingsSaveFailed: 'TTS-Einstellungen konnten nicht gespeichert werden.',
      storedSecretCleared: 'Gespeichertes TTS-Secret vom Server gelöscht.',
      storedSecretClearFailed: 'Gespeichertes TTS-Secret konnte nicht gelöscht werden.',
      mimoCloneAudioInvalid: 'MiMo-Klonaudio muss eine MP3- oder WAV-Datei sein.',
      mimoCloneAudioTooLarge: 'MiMo-Klonaudio darf höchstens 10 MB groß sein.',
      mimoCloneAudioReadFailed: 'Audiodatei konnte nicht gelesen werden.',
      mimoCloneAudioCleared: 'Gespeichertes MiMo-Klonaudio vom Server gelöscht.',
      mimoCloneAudioClearFailed: 'Gespeichertes MiMo-Klonaudio konnte nicht gelöscht werden.',
