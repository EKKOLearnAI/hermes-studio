export default {
  ...
  chat: {
    ...
    imageTooLarge: 'Bild muss unter 5 MB sein',
    dragToPosition: 'Ziehen zum Positionieren · Scrollen oder Schieberegler zum Zoomen',
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimation: 'Denkanimation',
      thinkingAnimationHint: 'Die Animation anpassen, die wahrend der KI-Verarbeitung angezeigt wird',
      taHelp: 'Unterstützte Formate: GIF, MP4, MOV. Max. 100 MB.',
      taCustomLoaded: 'Benutzerdefinierte Animation geladen',
      taDefault: 'Standardanimation wird verwendet',
      taChange: 'Ändern',
      taUpload: 'Animation hochladen',
      taResetDefault: 'Auf Standard zurücksetzen',
      taFileTooLarge: 'Datei zu groß (max. 100 MB)',
      taUploadFailed: 'Upload fehlgeschlagen',
      taResetFailed: 'Zurücksetzen fehlgeschlagen',
      theme: 'Design',
  ...
  changelog: {
    ...
    new_0_4_3_1: 'Cross-Machine-Profilunterstützung mit BFF-Proxy-Routing hinzugefügt',
    new_0_4_3_2: 'Sitzungssuche mit Schlüsselwortsuche hinzugefügt',
    new_0_4_3_3: 'Kontextnutzungsverfolgung und Token-Anzeige hinzugefügt',
    new_0_4_3_4: 'Provider-aware Kontextlängen-Suche hinzugefügt',
    new_0_4_1_1: 'Erstveröffentlichung von Hermes Web UI mit Chat, Modellen und Sitzungen',
  },
  ...
  // Gateway Tabs
  gatewayTabs: {
    cannotDeleteActive: 'Aktives Profil kann nicht gelöscht werden',
    ...
    export: 'Exportieren',
    exported: 'Profil "{name}" exportiert',
    exportFailed: 'Profil konnte nicht exportiert werden',
    namePlaceholder: 'Profilname eingeben',
    nameRequired: 'Profilname ist erforderlich',
    newProfile: 'Neues Profil',
    noProfiles: 'Keine Profile',
    rename: 'Umbenennen',
    renamed: 'Profil "{from}" in "{to}" umbenannt',
