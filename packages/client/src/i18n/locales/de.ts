...
jobTriggered: 'Job ausgelost',
  ...
  groupChat: {
    ...
    handoffModeMentions: 'Erwähnungen aus Agent-Ausgaben',
    handoffModeFixed: 'Feste Teilnehmerreihenfolge',
    fixedHandoffOrder: 'Feste Übergabereihenfolge',
    invalidFixedHandoffOrder: 'Für die feste Reihenfolge sind mindestens zwei eindeutige Teilnehmer erforderlich',
    ...
    moveHandoffUp: 'Nach oben',
    moveHandoffDown: 'Nach unten',
    handoffPending: 'Übergabe ausstehend',
    handoffRunning: 'Übergabe läuft',
    handoffFailed: 'Übergabe fehlgeschlagen',
    handoffInterrupted: 'Übergabe unterbrochen',
    activityDock: 'Aktuelle Aktivität',
    activityStep: 'Schritt {step}/{total}',
    viewHandoffProgress: 'Fortschritt anzeigen',
    stopHandoff: 'Gesamte Übergabe stoppen',
    stopReply: 'Antwort von {agent} stoppen',
    stoppingActivity: 'Wird gestoppt...',
    activityCompleted: 'Abgeschlossen',
    activityRunning: 'Läuft',
    activityPending: 'Ausstehend',
    automaticHandoffSettings: 'Automatische Übergaben',
    maxAutomaticHandoffs: 'Maximale automatische Übergaben',
    unlimitedAutomaticHandoffs: 'Unbegrenzt',
    maxAutomaticHandoffsDesc: "Begrenzt Agent-zu-Agent-Übergaben per {'@'}Erwähnung, die durch eine Benutzernachricht ausgelöst werden. {'@'}all bleibt parallel.",
    roomSettingsSaved: 'Raumeinstellungen gespeichert',
    invalidAutomaticHandoffLimit: 'Geben Sie eine positive Ganzzahl ein oder aktivieren Sie Unbegrenzt',
    saveRoomSettings: 'Einstellungen speichern',
