...
jobTriggered: 'Job ausgelost',
  ...
  workflow: {
    ...
    edgeEditor: {
      ...
      conditionPathOptions: { routeOnly: 'Nur Route — keine Inhaltsprüfung', outputRecommended: 'Erfolgreicher Antworttext (output, empfohlen)', output: 'Erfolgreicher Antworttext (output)', outputJson: 'Strukturiertes Antwort-JSON (outputJson.*)', errorRecommended: 'Fehlertext (error, empfohlen)', error: 'Fehlertext (error)', custom: 'Eigener Pfad (erweitert)' },
