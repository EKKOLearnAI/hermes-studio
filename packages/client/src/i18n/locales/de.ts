export default {
  ...
  sidebar: {
    ...
    updateTip: 'Fuhren Sie "audbuild update" im Terminal aus, um zu aktualisieren',
  ...
  chat: {
    ...
    emptyState: 'Starten Sie eine Konversation mit audbuild',
    ...
    hermesHistory: 'audbuild-Verlauf',
    historyScopeHint: 'Schreibgeschützte audbuild-Verlaufssitzungen, nach Quelle gruppiert.',
...
jobTriggered: 'Job ausgelost',
  ...
  plugins: {
    ...
    notice: 'Schreibgeschütztes Inventar erkennbarer audbuild-Plugin-Manifeste. Discovery-Metadaten werden gelesen, ohne Plugin-Code zu laden. Verwaltungsaktionen bleiben in v1 im CLI; Änderungen gelten für neue audbuild-Sitzungen.',
  ...
  models: {
    ...
    copilotAddDetected: 'Auf diesem Rechner wurde ein GitHub Copilot OAuth-Token erkannt. Klicken Sie auf „Hinzufügen", um Copilot in audbuild zu aktivieren.',
    ...
    copilotDeleteHintGhCli: 'Copilot wird aus audbuild ausgeblendet. Ihre gh CLI-Anmeldung bleibt erhalten — `gh auth status` zeigt weiterhin als angemeldet.',
    copilotDeleteHintAppsJson: 'Copilot wird aus audbuild ausgeblendet. Ihre VS Code Copilot-Erweiterung bleibt angemeldet.',
  ...
  skillsUsage: {
    title: 'Skill-Nutzung',
    subtitle: 'Skill-Ladevorgänge und -Bearbeitungen aus audbuild-Sitzungen verfolgen',
    refresh: 'Aktualisieren',
  ...
  changelog: {
    ...
    new_0_5_15_9: 'audbuild Markdown-Medien-Rendering und Sync-Wiederholung korrigiert',
    new_0_5_15_10: 'Upstream-Umgebungsvariablenabhängigkeit entfernt',
    new_0_5_15_11: 'Wenn die Kanban-Funktion nicht verfügbar ist, updaten Sie bitte audbuild',
    ...
    new_0_5_17_3: 'Plugin-Erkennung auf Termux repariert durch Parsen des audbuild-Shebangs zur Python-Lokalisierung',
    ...
    new_0_5_17_9: 'Schreibgeschuetzte audbuild-Plugins-Seite hinzugefuegt',
    ...
    new_0_5_22_1: 'Fix audbuild session list API reading the Web UI local session store instead of the audbuild profile database',
    ...
    new_0_5_5_2: 'Verlaufsseite für audbuild-Sitzungshistorie hinzugefügt',
    ...
    new_0_5_4_4: 'Fix web terminal audbuild CLI availability after Docker deployment',
    ...
    new_0_5_4_7: 'Align usage analytics with audbuild state DB schema',
    ...
    new_0_4_8_7: 'Fix login token validation using audbuild session endpoint',
    ...
    new_0_4_8_10: 'Move upload directory from temp to ~/.audbuild/upload',
