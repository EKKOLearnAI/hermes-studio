﻿﻿﻿export default {
  ...
  login: {
    ...
    defaultCredentialsHint: 'Standard-Benutzername: quanthermes. Standard-Passwort: 12345678.',
  ...
  sidebar: {
    ...
    updateTip: 'Aktualisierungen fur angepasste Builds werden intern bereitgestellt',
    ...
    updateFailed: 'Aktualisierung fehlgeschlagen. Prufen Sie die interne Update-Quelle.',
    updateSource: 'Update-Quelle: {source}',
    updateManagedInternally: 'Angepasster Build: Aktualisierungen werden intern verwaltet',
    logout: 'Abmelden',
  ...
  chat: {
    ...
    hermesHistory: 'QuantHermes-Verlauf',
    historyScopeHint: 'Schreibgeschützte QuantHermes-Verlaufssitzungen, nach Quelle gruppiert.',
...
jobTriggered: 'Job ausgelost',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Aktualisieren',
    notice: 'Schreibgeschütztes Inventar erkennbarer QuantHermes-Plugin-Manifeste. Discovery-Metadaten werden gelesen, ohne Plugin-Code zu laden. Verwaltungsaktionen bleiben in v1 im CLI; Änderungen gelten für neue QuantHermes-Sitzungen.',
  ...
  models: {
    ...
    copilotAddDetected: 'Auf diesem Rechner wurde ein GitHub Copilot OAuth-Token erkannt. Klicken Sie auf „Hinzufügen", um Copilot in QuantHermes zu aktivieren.',
    ...
    copilotDeleteHintGhCli: 'Copilot wird aus QuantHermes ausgeblendet. Ihre gh CLI-Anmeldung bleibt erhalten — `gh auth status` zeigt weiterhin als angemeldet.',
    copilotDeleteHintAppsJson: 'Copilot wird aus QuantHermes ausgeblendet. Ihre VS Code Copilot-Erweiterung bleibt angemeldet.',
  ...
  skillsUsage: {
    title: 'Skill-Nutzung',
    subtitle: 'Skill-Ladevorgänge und -Bearbeitungen aus QuantHermes-Sitzungen verfolgen',
    refresh: 'Aktualisieren',
  ...
  changelog: {
    ...
    new_0_6_0_7: 'CLI-Wartungsbefehle zum Löschen von Login-IP-Sperren und Zurücksetzen des Standard-Logins quanthermes / 12345678 hinzugefügt',
