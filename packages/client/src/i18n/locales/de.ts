export default {
  ...
  login: {
    ...
    tokenLogin: 'Token',
    feishuLogin: 'Mit Feishu anmelden',
    ...
    feishuUatTitle: 'Feishu-Tools autorisieren',
    feishuUatDescription: 'Schliessen Sie die Feishu-Autorisierung ab, damit Hermes Feishu-APIs in Ihrem Namen nutzen kann.',
    feishuUatOpen: 'Feishu-Autorisierung offnen',
    feishuUatFailed: 'Feishu-Autorisierung fehlgeschlagen',
  },
  ...
  sidebar: {
    ...
    feishuConnected: 'Feishu verbunden',
    feishuNotConnected: 'Feishu nicht verbunden',
    feishuChecking: 'Feishu-Verbindung wird gepruft',
    feishuConnecting: 'Feishu wird verbunden',
    feishuConnectFailed: 'Feishu-Verbindung fehlgeschlagen',
  ...
  chat: {
    ...
    loadSessionsFailed: 'Sitzungen konnten nicht geladen werden',
    retrySessions: 'Wiederholen',
    exitBatchMode: 'Stapelmodus beenden',
    tooManySessionsInGroup: '{shown} von {total} angezeigt — Suche nutzen, um ältere Konversationen zu finden',
    historyEmptyTitle: 'Kein Verlauf für dieses Profil',
    historyEmptyHint: 'Sitzungen aus dem mit dieser Anmeldung verknüpften Hermes-Profil erscheinen hier, sobald CLI, Feishu oder andere Kanäle Einträge erstellen.',
    newChat: 'Neuer Chat',
  ...
  jobs: {
    ...
    gatewayUnavailableHint: 'The system is connecting this profile task service; retry shortly.',
    name: 'Name',
