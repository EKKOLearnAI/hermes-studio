...
jobTriggered: 'Job ausgelost',
  ...
  models: {
    ...
    noModels: 'Keine Modelle verfügbar. Stellen Sie sicher, dass mindestens ein Provider einen API-Schlüssel konfiguriert hat, oder fügen Sie einen benutzerdefinierten Provider in den Einstellungen hinzu.',
    noResults: 'Keine übereinstimmenden Modelle gefunden.',
