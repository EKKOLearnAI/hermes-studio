export default {
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimationHint: 'Animation während der KI-Verarbeitung anpassen',
      taCustomLoaded: 'Benutzerdefinierte Animation geladen',
      taDefault: 'Standard-Animation wird verwendet',
      taChange: 'Ändern',
      taUpload: 'Hochladen',
      taResetDefault: 'Auf Standard zurücksetzen',
      taHelp: 'Unterstützt GIF, MP4, WebM. MOV/AVI/MKV werden automatisch in MP4 konvertiert. Max. 100MB.',
      taFileTooLarge: 'Datei zu groß (max. 100MB)',
      taUploadFailed: 'Hochladen fehlgeschlagen',
