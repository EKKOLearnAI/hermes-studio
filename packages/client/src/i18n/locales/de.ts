export default {
  ...
  chat: {
    ...
    archived: 'Sitzung archiviert',
    unarchived: 'Sitzung dearchiviert',
...
jobTriggered: 'Job ausgelost',
  ...
  settings: {
    ...
    agent: {
      ...
      reasoningEffort: 'Schliefungstiefe',
      reasoningEffortHint: 'Denktiefe des Modells steuern (low/medium/high/xhigh)',
      default: 'Standard',
      auto: 'Automatisch',
      always: 'Immer',
      never: 'Nie',
  ...
  download: {
    ...
    openFile: 'Mit Standard-App öffnen',
    openFileFailed: 'Datei konnte nicht geöffnet werden',
    showInFolder: 'Im Ordner anzeigen',
    showInFolderFailed: 'Ordner konnte nicht geöffnet werden',
  },
  gateways: {
    title: 'Gateways',
    running: 'Läuft',
