export default {
  ...
  models: {
    ...
    copilotLoginIntro: 'Hermes Web UI nutzt die GitHub-Authentifizierung über das lokale gh CLI. Einmal anmelden und Zugangsdaten werden wiederverwendet.',
    copilotStep1: 'Stellen Sie sicher, dass GitHub CLI (gh) auf diesem Rechner installiert ist.',
    copilotStep2: 'Führen Sie folgenden Befehl in einem Terminal aus:',
    copilotStep3: 'Klicken Sie nach Abschluss der Browser-Autorisierung unten auf "Erkennung aktualisieren".',
    copilotLoginNote: 'Die Autorisierung wird vom gh CLI auf diesem Rechner gespeichert und bleibt nach einem Neustart der Web UI gültig.',
    copilotCopied: 'Befehl kopiert',
    copilotDetected: 'GitHub Copilot erkannt und einsatzbereit.',
    copilotNotDetected: 'Copilot-Autorisierung noch nicht erkannt. Bitte prüfen Sie, ob `gh auth login` erfolgreich war.',
    copilotRefresh: 'Erkennung aktualisieren',
