export default {
  ...
  models: {
    ...
    copilotLoginIntro: 'O Hermes Web UI compartilha autenticação do GitHub via CLI gh local. Faça login uma vez e as credenciais serão reutilizadas.',
    copilotStep1: 'Verifique se o GitHub CLI (gh) está instalado nesta máquina.',
    copilotStep2: 'Execute o seguinte comando em um terminal do sistema:',
    copilotStep3: 'Após concluir a autorização no navegador, clique em "Atualizar detecção" abaixo.',
    copilotLoginNote: 'A autorização é persistida pelo gh CLI nesta máquina e permanece válida após reiniciar o Web UI.',
    copilotCopied: 'Comando copiado',
    copilotDetected: 'GitHub Copilot detectado e pronto para uso.',
    copilotNotDetected: 'Autorização do Copilot ainda não detectada. Confirme que `gh auth login` foi concluído.',
    copilotRefresh: 'Atualizar detecção',
