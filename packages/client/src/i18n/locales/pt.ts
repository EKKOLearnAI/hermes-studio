export default {
  ...
  chat: {
    ...
    imageTooLarge: 'A imagem deve ter menos de 5 MB',
    dragToPosition: 'Arraste para posicionar · Role ou use o controle para zoom',
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimation: 'Animacao de pensamento',
      thinkingAnimationHint: 'Personalizar a animacao exibida enquanto a IA processa',
      taHelp: 'Formatos suportados: GIF, MP4, MOV. Max. 100 MB.',
      taCustomLoaded: 'Animacao personalizada carregada',
      taDefault: 'Usando animacao padrao',
      taChange: 'Alterar',
      taUpload: 'Carregar animacao',
      taResetDefault: 'Redefinir para padrao',
      taFileTooLarge: 'Arquivo muito grande (max. 100 MB)',
      taUploadFailed: 'Falha no upload',
      taResetFailed: 'Falha ao redefinir',
      theme: 'Tema',
  ...
  changelog: {
    ...
    new_0_4_3_1: 'Suporte a perfis multi-máquina com roteamento proxy BFF',
    new_0_4_3_2: 'Busca de sessões por palavra-chave',
    new_0_4_3_3: 'Rastreamento de uso de contexto e exibição de tokens',
    new_0_4_3_4: 'Busca de comprimento de contexto por provedor',
    new_0_4_1_1: 'Versão inicial do Hermes Web UI com chat, modelos e sessões',
  },
  ...
  gatewayTabs: {
    ...
    delete: 'Excluir',
    deleted: 'Perfil "{name}" excluído',
    deleteFailed: 'Falha ao excluir perfil',
    export: 'Exportar',
    exported: 'Perfil "{name}" exportado',
    exportFailed: 'Falha ao exportar perfil',
    namePlaceholder: 'Digite o nome do perfil',
    nameRequired: 'Nome do perfil é obrigatório',
    newProfile: 'Novo perfil',
    noProfiles: 'Sem perfis',
    rename: 'Renomear',
    renamed: 'Perfil "{from}" renomeado para "{to}"',
    renameFailed: 'Falha ao renomear perfil',
