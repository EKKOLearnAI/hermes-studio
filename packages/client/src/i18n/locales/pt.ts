...
jobTriggered: 'Job acionado',
  ...
  profiles: {
    ...
    thinkingAnimation: {
      title: 'Animação de pensamento personalizada',
      customize: 'Animação',
      upload: 'Carregar arquivo',
      save: 'Salvar',
      reset: 'Usar padrão',
      hint: 'GIF, WebP, MP4 ou WebM. M\u00e1x. 5 MB.',
      invalidType: 'Escolha um arquivo GIF, WebP, MP4, WebM ou imagem',
      tooLarge: 'O arquivo deve ter 5 MB ou menos',
      saveSuccess: 'Animação de pensamento salva',
      saveFailed: 'Falha ao salvar animação',
      resetSuccess: 'Animação padr\u00e3o restaurada',
      resetFailed: 'Falha ao restaurar',
      urlPlaceholder: 'Cole a URL ou deixe vazio para o padr\u00e3o',
      noPreview: 'Sem animação personalizada',
      enableThinking: 'Habilitar animação de pensamento',
      delete: 'Excluir animação',
      maxReached: 'M\u00e1ximo de {max} animações atingido',
      savedItems: '{count} anima\u00e7\u00e3o(\u00f5es) salva(s)',
    },
    runtime: {
