export default {
  ...
  sidebar: {
    ...
    updateTip: 'Execute "audbuild update" no terminal para atualizar',
  ...
  chat: {
    ...
    emptyState: 'Inicie uma conversa com o audbuild',
    ...
    hermesHistory: 'Histórico audbuild',
    historyScopeHint: 'Sessões do histórico audbuild somente leitura, agrupadas por origem.',
...
jobTriggered: 'Job acionado',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Atualizar',
    notice: 'Inventário somente leitura dos manifests de plugins audbuild detectáveis. Os metadados de descoberta são lidos sem carregar código de plugin. No v1, ações de gerenciamento ficam na CLI; mudanças entram em vigor em novas sessões audbuild.',
  ...
  models: {
    ...
    copilotAddDetected: 'Foi detectado um token OAuth do GitHub Copilot nesta máquina. Clique em Adicionar para ativar o Copilot no audbuild.',
    ...
    copilotDeleteHintGhCli: 'O Copilot ficará oculto no audbuild. Sua sessão no gh CLI não é afetada — `gh auth status` continuará indicando que está conectado.',
    copilotDeleteHintAppsJson: 'O Copilot ficará oculto no audbuild. A extensão Copilot do VS Code continuará conectada.',
  ...
  skillsUsage: {
    ...
    subtitle: 'Acompanhe carregamentos e edições de habilidades nas sessões audbuild',
    refresh: 'Atualizar',
  ...
  changelog: {
    ...
    new_0_5_15_11: 'Se o recurso Kanban não estiver disponível, atualize o audbuild',
    ...
    new_0_5_17_9: 'Adicionar página de plugins audbuild somente leitura',
    ...
    new_0_5_5_2: 'Adicionada página de histórico para sessões audbuild',
