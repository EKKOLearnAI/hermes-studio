...
jobTriggered: 'Job acionado',
  ...
  workflow: {
    ...
    edgeEditor: {
      ...
      conditionPathOptions: { routeOnly: 'Somente rota — sem condição', outputRecommended: 'Texto da resposta com sucesso (output, recomendado)', output: 'Texto da resposta com sucesso (output)', outputJson: 'JSON de resposta estruturado (outputJson.*)', errorRecommended: 'Texto do erro (error, recomendado)', error: 'Texto do erro (error)', custom: 'Caminho personalizado (avançado)' },
