﻿﻿﻿export default {
  ...
  login: {
    ...
    defaultCredentialsHint: 'Nome de usuario padrao: quanthermes. Senha padrao: 12345678.',
  ...
  sidebar: {
    ...
    updateTip: 'As atualizacoes do build personalizado sao gerenciadas internamente',
    ...
    updateFailed: 'Falha na atualizacao. Verifique a fonte interna.',
    updateSource: 'Fonte de atualizacao: {source}',
    updateManagedInternally: 'Build personalizado: as atualizacoes sao gerenciadas internamente',
    logout: 'Sair',
  ...
  chat: {
    ...
    emptyState: 'Inicie uma conversa com o Quanthermes Agent',
    ...
    hermesHistory: 'Histórico QuantHermes',
    historyScopeHint: 'Sessões do histórico QuantHermes somente leitura, agrupadas por origem.',
...
jobTriggered: 'Job acionado',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Atualizar',
    notice: 'Inventário somente leitura dos manifests de plugins QuantHermes detectáveis. Os metadados de descoberta são lidos sem carregar código de plugin. No v1, ações de gerenciamento ficam na CLI; mudanças entram em vigor em novas sessões QuantHermes.',
  ...
  models: {
    ...
    copilotAddDetected: 'Foi detectado um token OAuth do GitHub Copilot nesta máquina. Clique em Adicionar para ativar o Copilot no QuantHermes.',
    ...
    copilotDeleteHintGhCli: 'O Copilot ficará oculto no QuantHermes. Sua sessão no gh CLI não é afetada — `gh auth status` continuará indicando que está conectado.',
    copilotDeleteHintAppsJson: 'O Copilot ficará oculto no QuantHermes. A extensão Copilot do VS Code continuará conectada.',
  ...
  skillsUsage: {
    ...
    subtitle: 'Acompanhe carregamentos e edições de habilidades nas sessões QuantHermes',
    refresh: 'Atualizar',
  ...
  changelog: {
    ...
    new_0_6_0_7: 'Adiciona comandos CLI de manutenção para limpar bloqueios de IP de login e redefinir o login padrão quanthermes / 12345678',
