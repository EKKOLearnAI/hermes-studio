export default {
  ...
  chat: {
    ...
    unarchived: 'Sessão desarquivada',
...
jobTriggered: 'Job acionado',
  ...
  settings: {
    ...
    agent: {
      ...
      reasoningEffort: 'Profundidade de raciocínio',
      reasoningEffortHint: 'Controlar a profundidade de pensamento do modelo (low/medium/high/xhigh)',
      default: 'Padrão',
      auto: 'Automatico',
      always: 'Sempre',
      never: 'Nunca',
  ...
  download: {
    ...
    openFile: 'Abrir com aplicativo padrão',
    openFileFailed: 'Falha ao abrir arquivo',
    showInFolder: 'Mostrar na pasta',
    showInFolderFailed: 'Falha ao abrir pasta',
  },
  gateways: {
    title: 'Gateways',
    running: 'Em execução',
