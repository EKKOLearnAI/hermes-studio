...
jobTriggered: 'Job acionado',
  ...
  models: {
    ...
    noModels: 'Nenhum modelo disponível. Certifique-se de que pelo menos um provedor tenha uma chave API configurada, ou adicione um provedor personalizado em Configurações → Modelos.',
    noResults: 'Nenhum modelo correspondente encontrado.',
