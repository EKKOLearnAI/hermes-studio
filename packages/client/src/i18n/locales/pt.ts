export default {
  ...
  runtimeVersions: {
    ...
    runtimeDirectoryHint: 'O Runtime atual será copiado e verificado antes de iniciar os serviços locais na próxima reinicialização. A cópia anterior será mantida.',
    ...
    runtimeMigrationFailed: 'A migração do Runtime falhou; o Runtime anterior continua em uso',
    active: 'Ativa',
    installed: 'Instalada',
    download: 'Baixar',
...
jobTriggered: 'Job acionado',
  ...
  changelog: {
    ...
    new_0_6_31_12: 'O gerenciamento de versões agora permite realocar o armazenamento do Runtime; a migração ocorre antes dos serviços na próxima reinicialização e mantém a cópia anterior (#2134)',
