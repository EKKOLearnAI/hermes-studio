export default {
  ...
  login: {
    ...
    feishuUatTitle: 'Autorizar ferramentas Feishu',
    feishuUatDescription: 'Conclua a autorizacao Feishu para que o Hermes use APIs Feishu em seu nome.',
    feishuUatOpen: 'Abrir autorizacao Feishu',
    feishuUatFailed: 'Falha na autorizacao Feishu',
  },
  ...
  sidebar: {
    ...
    feishuConnected: 'Feishu conectado',
    feishuNotConnected: 'Feishu nao conectado',
    feishuChecking: 'Verificando conexao Feishu',
    feishuConnecting: 'Conectando Feishu',
    feishuConnectFailed: 'Falha na conexao Feishu',
  ...
  chat: {
    ...
    loadSessionsFailed: 'Falha ao carregar sessoes',
    retrySessions: 'Tentar novamente',
    exitBatchMode: 'Sair do modo em lote',
    tooManySessionsInGroup: 'Mostrando {shown} de {total} — use a busca para conversas mais antigas',
    historyEmptyTitle: 'Sem histórico para este perfil',
    historyEmptyHint: 'As sessões do perfil Hermes vinculado a este login aparecerão aqui quando CLI, Feishu ou outros canais criarem registros.',
    newChat: 'Novo chat',
