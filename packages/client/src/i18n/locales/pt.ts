...
jobTriggered: 'Job acionado',
  ...
  settings: {
    ...
    voice: {
      ...
      clearStoredKey: 'Limpar chave salva',
      storedServerKey: 'Chave salva no servidor: {value}',
      secretPendingSave: 'sera atualizada ao salvar',
      storedOnServer: 'Salvo no servidor',
      saveTtsSettings: 'Salvar configuracoes TTS',
      webspeechSettingsSaved: 'Configuracoes WebSpeech salvas localmente.',
      ttsSettingsSaved: 'Configuracoes TTS salvas no servidor.',
      ttsSettingsSaveFailed: 'Falha ao salvar configuracoes TTS.',
      storedSecretCleared: 'Segredo TTS salvo removido do servidor.',
      storedSecretClearFailed: 'Falha ao remover segredo TTS salvo.',
      mimoCloneAudioInvalid: 'O audio de clonagem MiMo deve ser mp3 ou wav.',
      mimoCloneAudioTooLarge: 'O audio de clonagem MiMo deve ter 10 MB ou menos.',
      mimoCloneAudioReadFailed: 'Falha ao ler o arquivo de audio.',
      mimoCloneAudioCleared: 'Audio de clonagem MiMo salvo removido do servidor.',
      mimoCloneAudioClearFailed: 'Falha ao remover audio de clonagem MiMo salvo.',
