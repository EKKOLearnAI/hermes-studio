export default {
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimationHint: 'Personalizar a animação exibida enquanto a IA está processando',
      taCustomLoaded: 'Animação personalizada carregada',
      taDefault: 'Usando animação padrão',
      taChange: 'Alterar',
      taUpload: 'Enviar',
      taResetDefault: 'Redefinir para padrão',
      taHelp: 'Suporta GIF, MP4, WebM. MOV/AVI/MKV são convertidos automaticamente para MP4. Máx. 100MB.',
      taFileTooLarge: 'Arquivo muito grande (máx. 100MB)',
      taUploadFailed: 'Falha no envio',
