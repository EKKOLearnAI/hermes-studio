export default {
  ...
  models: {
    ...
    copilotLoginIntro: 'Hermes Web UI는 로컬 gh CLI를 통해 GitHub 인증을 공유합니다. 한 번 로그인하면 자격 증명이 재사용됩니다.',
    copilotStep1: '이 컴퓨터에 GitHub CLI(gh)가 설치되어 있는지 확인하세요.',
    copilotStep2: '시스템 터미널에서 다음 명령을 실행하세요:',
    copilotStep3: '브라우저 인증 완료 후 아래 "감지 새로 고침"을 클릭하세요.',
    copilotLoginNote: '인증은 이 컴퓨터의 gh CLI에 의해 유지되며, Web UI 재시작 후에도 유효합니다.',
    copilotCopied: '명령이 복사되었습니다',
    copilotDetected: 'GitHub Copilot이 감지되어 사용 가능합니다.',
    copilotNotDetected: 'Copilot 인증이 아직 감지되지 않았습니다. `gh auth login`이 완료되었는지 확인하세요.',
    copilotRefresh: '감지 새로 고침',
    customBadge: '커스텀',
    previewBadge: '프리뷰',
    disabledBadge: '사용 불가',
