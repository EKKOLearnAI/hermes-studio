export default {
  ...
  sidebar: {
    ...
    connected: '연결됨',
    disconnected: '연결 끊김',
    feishuConnected: 'Feishu 연결됨',
    feishuNotConnected: 'Feishu 미연결',
    feishuChecking: 'Feishu 연결 확인 중',
    feishuConnecting: 'Feishu 연결 중',
    feishuConnectFailed: 'Feishu 연결 실패',
  ...
  chat: {
    ...
    noSessions: '세션 없음',
    loadSessionsFailed: '세션 불러오기 실패',
    retrySessions: '다시 시도',
    exitBatchMode: '일괄 모드 종료',
    tooManySessionsInGroup: '{total}개 중 {shown}개 표시 — 이전 대화는 검색을 사용하세요',
    historyEmptyTitle: '이 프로필의 기록이 없습니다',
    historyEmptyHint: '이 로그인에 연결된 Hermes 프로필의 세션은 CLI, Feishu 또는 다른 채널에서 기록이 생성되면 여기에 표시됩니다.',
    newChat: '새 채팅',
