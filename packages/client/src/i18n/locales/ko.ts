...
export default {
  dshPlugins: {
    ...
    "succeeded": "성공",
    "failed": "실패",
    "description": "Studio의 네이티브 ACP 플러그인은 각 대화의 다음 DSH 시작에 적용됩니다. 실행 중인 프로세스는 기존 버전을 유지합니다. 브라우저 통합은 아직 지원하지 않습니다.",
    "installHint": "패키지{'@'}정확한버전을 입력하세요. 설치 스크립트는 실행되지 않으며 새 번들은 직접 활성화해야 합니다. 신뢰하는 패키지만 설치하세요.",
    "removeConfirm": "다음 시작부터 {name}을 제거할까요?",
    "runtimeUnknown": "설정 상태만 표시합니다. 실행 상태와 호환성은 검증되지 않았습니다.",
    "entries": "선언된 플러그인 항목",
    "discard": "초안을 버리고 최근 저장된 설정을 불러올까요?",
    "configHint": "활성화된 번들 다음에 적용되는 YAML 패치입니다. 다음 DSH 시작 시 반영됩니다.",
    "rollbackConfirm": "다음 시작부터 이 보관 버전을 사용할까요?",
    "conflict": "설정이 변경되었습니다. 초안은 유지됩니다. 최신 버전과 비교한 뒤 다시 불러오세요.",
    "missingDependency": "먼저 DSH와 pnpm을 설치하세요.",
    "busy": "다른 작업이 진행 중이거나 패키지 상태가 충돌합니다. 새로고침 후 다시 시도하세요.",
    "interrupted": "작업이 중단되었습니다. 기존 버전이 유지됩니다.",
    "unsupported": "네이티브 ACP 관리에서 지원하지 않는 패키지 또는 기능입니다.",
    "invalid": "정확한 패키지 버전 또는 YAML 패치 목록을 확인하세요.",
    "timeout": "작업 시간이 초과되었습니다. 기존 버전이 유지됩니다."
},
