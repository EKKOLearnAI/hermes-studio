export default {
  ...
  settings: {
    ...
    voice: {
      ...
      doubaoCloneVoiceHint: '음성 ID,음성 이름 형식으로 입력하세요. 여러 음성을 저장할 수 있습니다.',
      doubaoCloneVoicePlaceholder: '예: S_xxxxx,내 음성',
      doubaoCloneVoiceFormatError: '음성 ID,음성 이름 형식을 사용하세요.',
      apiKey: 'API 키',
