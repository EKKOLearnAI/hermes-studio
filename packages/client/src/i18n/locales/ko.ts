export default {
  ...
  sidebar: {
    ...
    connected: '연결됨',
    disconnected: '연결 끊김',
    updateTip: '터미널에서 "audbuild update"를 실행하여 업데이트하세요',
  ...
  chat: {
    ...
    emptyState: 'audbuild와 대화를 시작하세요',
    ...
    openHistory: '기록 열기',
    hermesHistory: 'audbuild 기록',
    historyScopeHint: '소스별로 그룹화된 audbuild 기록 세션을 읽기 전용으로 봅니다.',
    noSessions: '세션 없음',
    newChat: '새 채팅',
  ...
  plugins: {
    title: '플러그인',
    refresh: '새로고침',
    notice: '탐색 가능한 audbuild 플러그인 manifest의 읽기 전용 인벤토리입니다. 탐색 메타데이터는 플러그인 코드를 로드하지 않고 읽습니다. v1의 관리 작업은 CLI에 유지되며, 변경 사항은 새 audbuild 세션에서 적용됩니다.',
  ...
  models: {
    ...
    copilotAddDetected: '이 컴퓨터에서 GitHub Copilot OAuth 토큰이 감지되었습니다. 추가를 클릭하여 audbuild에서 Copilot을 활성화하세요.',
    ...
    copilotDeleteHintGhCli: 'Copilot이 audbuild에서 숨겨집니다. gh CLI 로그인에는 영향이 없으며 `gh auth status`는 여전히 로그인 상태를 표시합니다.',
    copilotDeleteHintAppsJson: 'Copilot이 audbuild에서 숨겨집니다. VS Code Copilot 확장 로그인에는 영향이 없습니다.',
    customBadge: '커스텀',
    previewBadge: '프리뷰',
    disabledBadge: '사용 불가',
  ...
  skillsUsage: {
    title: '스킬 사용량',
    subtitle: 'audbuild 세션의 스킬 로드와 편집을 추적합니다',
    refresh: '새로고침',
  ...
  changelog: {
    ...
    new_0_5_15_9: 'audbuild Markdown 미디어 렌더링 및 동기화 재시도 수정',
    new_0_5_15_10: '업스트림 환경 변수 종속성 제거',
    new_0_5_15_11: '칸반 기능을 사용할 수 없는 경우 audbuild를 업그레이드하세요',
    ...
    new_0_5_17_9: '읽기 전용 audbuild 플러그인 페이지 추가',
    ...
    new_0_5_5_2: 'audbuild 세션 기록 페이지 추가',
