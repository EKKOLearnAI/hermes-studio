export default {
  ...
  changelog: {
    ...
    new_0_6_37_2: 'Group Chat은 매번 새로 격리된 실행을 시작하고 각 답변을 reasoning 및 도구 과정과 함께 묶어 표시합니다. 공유 편집형 롤링 요약, 상태와 경계, Agent mention, 방/workspace drawer 및 이전 방 마이그레이션 안내도 추가했습니다(#2334)',
