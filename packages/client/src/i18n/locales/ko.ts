export default {
  ...
  chat: {
    ...
    addAgent: 'Agent 추가',
    participantQuickSettings: '참가자 설정',
    mentionParticipant: '참가자 멘션',
    participantSettingsNextRun: '변경 사항은 이 참가자의 다음 실행부터 적용됩니다.',
    participantSettingsSaved: '참가자 설정이 저장되었습니다',
    participantRuntime: '런타임',
    participantMode: '모드',
    participantModel: '모델',
  ...
  groupChat: {
    ...
    activityDock: '현재 활동',
    activityStep: '{step}/{total}단계',
    viewHandoffProgress: '진행 상황 보기',
    stopHandoff: '전체 릴레이 중지',
    stopReply: '{agent} 답변 중지',
    stoppingActivity: '중지 중...',
    activityCompleted: '완료',
    activityRunning: '실행 중',
    activityPending: '대기 중',
