export default {
  ...
  profiles: {
    ...
    thinkingAnimation: {
      title: '사고 애니메이션 사용자 정의',
      customize: '애니메이션',
      upload: '파일 업로드',
      save: '저장',
      reset: '기본값 사용',
      hint: 'GIF, WebP, MP4, WebM. 최대 5MB.',
      invalidType: 'GIF, WebP, MP4, WebM 또는 이미지 파일을 선택하세요',
      tooLarge: '애니메이션 파일은 5MB 이하여야 합니다',
      saveSuccess: '사고 애니메이션이 저장되었습니다',
      saveFailed: '사고 애니메이션 저장에 실패했습니다',
      resetSuccess: '기본 사고 애니메이션이 복원되었습니다',
      resetFailed: '기본값 복원에 실패했습니다',
      urlPlaceholder: '이미지/비디오 URL 붙여넣기, 비워두면 기본값',
      noPreview: '사용자 정의 애니메이션 미설정',
      enableThinking: '사고 애니메이션 활성화',
      delete: '애니메이션 삭제',
      maxReached: '최대 {max}개에 도달했습니다',
      savedItems: '{count}개 애니메이션 저장됨',
    },
    runtime: {
