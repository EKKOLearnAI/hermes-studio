...
export default {
  ...
  agentManager: {
    ...
    cursorNoManagedConfig: 'Cursor MCP 서버는 ~/.cursor/mcp.json에 있습니다. MCP 패널에서 편집하세요. CLI에 --mcp-config가 없어서 Studio가 관리 서버를 그 파일에 병합합니다.',
  ...
  connections: {
    ...
    app: {
      ...
      pushForDevice: "{name}의 푸시 알림",
      pushUpdateFailed: "푸시 알림 설정을 변경하지 못했습니다",
      online: '온라인',
      offline: '오프라인',
      active: '활성',
      expired: '만료됨',
