export default {
  ...
  runtimeVersions: {
    ...
    runtimeDirectoryHint: '다음 재시작 시 로컬 서비스를 시작하기 전에 현재 Runtime을 복사하고 검증합니다. 이전 복사본은 유지됩니다.',
    runtimeDirectorySaved: 'Runtime 마이그레이션을 예약했습니다. Hermes Studio를 다시 시작하면 실행됩니다.',
    runtimeMigrationPending: '마이그레이션 예정 위치: {directory}',
    runtimeMigrationFailed: 'Runtime 마이그레이션에 실패하여 이전 Runtime을 계속 사용합니다',
    active: '활성',
    installed: '설치됨',
    download: '다운로드',
  ...
  changelog: {
    ...
    new_0_6_31_12: '버전 관리에서 Runtime 저장 위치를 옮길 수 있으며, 다음 재시작 시 서비스 시작 전에 복사·검증하고 이전 복사본을 유지합니다 (#2134)',
