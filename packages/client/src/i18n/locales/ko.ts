﻿﻿﻿export default {
  ...
  sidebar: {
    ...
    connected: '연결됨',
    disconnected: '연결 끊김',
    updateTip: '커스텀 빌드 업데이트는 내부 배포 절차로 관리됩니다',
    ...
    updateFailed: '업데이트에 실패했습니다. 내부 업데이트 소스 구성을 확인하세요.',
    updateSource: '업데이트 소스: {source}',
    updateManagedInternally: '커스텀 빌드: 업데이트는 내부 배포 절차로 관리됩니다',
    logout: '로그아웃',
  ...
  changelog: {
    ...
    new_0_6_0_7: '로그인 IP 잠금을 지우고 기본 quanthermes / 12345678 로그인을 재설정하는 CLI 유지보수 명령을 추가했습니다',
