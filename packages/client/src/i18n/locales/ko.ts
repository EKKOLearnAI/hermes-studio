export default {
  ...
  settings: {
    ...
    voice: {
      ...
      clearStoredKey: '저장된 키 지우기',
      storedServerKey: '서버에 저장된 키: {value}',
      secretPendingSave: '저장 시 업데이트됨',
      storedOnServer: '서버에 저장됨',
      saveTtsSettings: 'TTS 설정 저장',
      webspeechSettingsSaved: 'WebSpeech 설정을 로컬에 저장했습니다.',
      ttsSettingsSaved: 'TTS 설정을 서버에 저장했습니다.',
      ttsSettingsSaveFailed: 'TTS 설정 저장에 실패했습니다.',
      storedSecretCleared: '서버에 저장된 TTS secret을 지웠습니다.',
      storedSecretClearFailed: '저장된 TTS secret 지우기에 실패했습니다.',
      mimoCloneAudioInvalid: 'MiMo 복제 오디오는 mp3 또는 wav 파일이어야 합니다.',
      mimoCloneAudioTooLarge: 'MiMo 복제 오디오는 10 MB 이하여야 합니다.',
      mimoCloneAudioReadFailed: '오디오 파일을 읽지 못했습니다.',
      mimoCloneAudioCleared: '서버에 저장된 MiMo 복제 오디오를 지웠습니다.',
      mimoCloneAudioClearFailed: '저장된 MiMo 복제 오디오 지우기에 실패했습니다.',
