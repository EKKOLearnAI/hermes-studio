export default {
  ...
  chat: {
    ...
    dragToPosition: '드래그로 위치 조정 · 스크롤 또는 슬라이더로 확대',
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimationHint: 'AI 처리 중에 표시되는 애니메이션 사용자 정의',
      taHelp: '지원 형식: GIF, MP4, MOV. 최대 100 MB.',
      taCustomLoaded: '사용자 정의 애니메이션 로드됨',
      taDefault: '기본 애니메이션 사용 중',
      taChange: '변경',
      taUpload: '애니메이션 업로드',
      taResetDefault: '기본값으로 재설정',
      taFileTooLarge: '파일이 너무 큽니다 (최대 100 MB)',
      taUploadFailed: '업로드 실패',
      taResetFailed: '재설정 실패',
      theme: '테마',
  ...
  changelog: {
    ...
    new_0_4_3_1: 'BFF 프록시 라우팅을 위한 크로스 머신 프로필 지원 추가',
    new_0_4_3_2: '키워드 매칭 세션 검색 추가',
    new_0_4_3_3: '컨텍스트 사용량 추적 및 토큰 표시 추가',
    new_0_4_3_4: '공급자별 컨텍스트 길이 조회 추가',
    new_0_4_1_1: 'Hermes Web UI 첫 출시, 채팅, 모델, 세션 관리 지원',
  },
  ...
  // Gateway Tabs
  gatewayTabs: {
    cannotDeleteActive: '활성 프로필은 삭제할 수 없습니다',
    created: '프로필 "{name}" 생성됨',
    createFailed: '프로필 생성 실패',
    createTitle: '프로필 생성',
    delete: '삭제',
    deleted: '프로필 "{name}" 삭제됨',
    deleteFailed: '프로필 삭제 실패',
    export: '내보내기',
    exported: '프로필 "{name}" 내보내기 완료',
    exportFailed: '프로필 내보내기 실패',
    namePlaceholder: '프로필 이름 입력',
    nameRequired: '프로필 이름이 필요합니다',
    newProfile: '새 프로필',
    noProfiles: '프로필 없음',
    rename: '이름 변경',
    renamed: '프로필 "{from}"을(를) "{to}"(으)로 변경',
    renameFailed: '프로필 이름 변경 실패',
