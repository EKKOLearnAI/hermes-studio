﻿﻿﻿﻿﻿﻿﻿export default {
  ...
  sidebar: {
    ...
    collapse: '收起選單',
    expand: '展開選單',
    updateTip: '定製版升級由內部發布流程管理',
    updateVersion: '升級版本 v{version}',
    reloadClientVersion: '重新整理到 v{version}',
    updating: '正在更新...',
    updateSuccess: '更新成功，請稍後重新整理頁面，如長時間未啟動，請手動重新啟動服務',
    updateFailed: '更新失敗，請檢查內部更新源配置',
  ...
  changelog: {
    ...
    new_0_6_0_7: '新增 CLI 維護命令，用於清理登入 IP 鎖與重設預設 quanthermes / 12345678 登入帳戶',
