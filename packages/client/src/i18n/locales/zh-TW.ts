export default {
  ...
  aurora: {
    brand: {
      ...
      subtitle: 'AI 作業層',
      bottomTitle: 'Aurora',
      bottomSubtitle: '你的 AI 作業層',
    },
    nav: {
      navigation: 'Aurora 導覽',
      system: 'Aurora 系統',
      home: '首頁',
      status: 'Aurora 系統狀態',
      memoryQueue: '記憶審核佇列',
    ...
    dock: {
      label: 'Aurora 工具 Dock',
      tools: '工具',
      files: '檔案',
      filesDesc: '工作區檔案',
      calendar: '行事曆',
      calendarDesc: '任務與排程工作',
      mail: '郵件',
      mailDesc: '頻道與收件橋接',
      memory: '記憶',
      memoryDesc: '受治理的記憶',
      chart: '圖表',
      chartDesc: 'TradingView 即時行情',
      sandbox: '沙盒',
      sandboxDesc: 'MiroFish 推演沙盒',
      openTool: '開啟{tool}',
      expandedLabel: '展開的 Aurora App 啟動器',
      expand: '展開 Aurora App 網格',
      collapse: '收起 Aurora App 網格',
      gridTitle: 'Aurora App 網格',
    },
    memoryStream: {
      aria: '神經記憶',
      title: '神經記憶',
      subtitle: '近期推演',
      refresh: '重新整理神經記憶',
      rehydrate: '重新喚回{topic}',
      recordsSource: 'MiroFish 紀錄',
      hydrating: '喚回中...',
      offline: '記憶離線',
      empty: '尚無推演',
      emptyHint: '執行一次 MiroFish 後，Aurora 會把最新結論固定在這裡。',
      fallbackPreview: '開啟這段記憶，即可在 MiroFish 中喚回辯論圖譜。',
      recent: '最近',
    },
    topbar: {
      quickControls: 'Aurora 快速控制',
      appMenu: 'Aurora App 選單',
      appMenuList: 'Aurora App 選單列表',
      apps: 'Aurora Apps',
      appsHint: '{profile} 桌面 · 已釘選優先，最近開啟會浮上來。',
      desktopPresets: 'Aurora 桌面預設',
      applyPreset: '套用{preset}桌面預設',
      openFromTopBar: '從頂欄開啟{app}',
      pinApp: '釘選{app}',
      unpinApp: '取消釘選{app}',
      pinned: '已釘選',
      export: '匯出',
      import: '匯入',
      desktop: '桌面',
      returnDesktop: '返回 Aurora 桌面',
      modelSelector: '模型選擇器',
      noModelsLoaded: '尚未載入模型',
      systemStatus: '系統狀態',
      ready: '就緒',
      offline: '離線',
      systemConnected: '系統已連線',
      systemOffline: '系統離線',
      usageTokens: '用量 {tokens} tokens',
      ...
      providers: '供應商',
      logout: '登出',
      clearAccessKey: '清除存取權杖',
      languageToggle: '切換語言',
      languageZh: '繁',
      languageEn: 'EN',
      profileSynced: '使用者已同步',
      profileSyncedDetail: '已儲存在 Hermes 使用者 {profile}。',
      syncing: '同步中',
      syncingDetail: 'Aurora 正在比對使用者偏好與本機桌面釘選。',
      localFallback: '本機備援',
      localFallbackDetail: '使用者同步暫不可用，因此 Aurora 僅使用此瀏覽器資料。',
      localReady: '本機就緒',
      localReadyDetail: '桌面釘選已在本機載入，待使用者偏好可用時會同步。',
      lastSync: ' 上次同步 {time}。',
      exportSuccess: '已匯出 {profile} 桌面。',
      importInvalid: '沒有找到有效的釘選 App。',
      importSuccess: '已為 {profile} 匯入 {count} 個釘選 App。',
      importFailed: '匯入失敗，請使用 Aurora 桌面 JSON 匯出檔。',
      presetApplied: '已套用{preset}桌面預設。',
    },
    omnibar: {
      modeLabel: 'OmniBar 模式',
      auroraModeLabel: 'Aurora 模式',
      placeholder: '今天想構建或執行什麼？',
      ask: '推演 Ask',
      build: '構建 Build',
      automate: '自動化 Automate',
      working: '執行中',
      command: '命令',
      processing: '處理中',
      context: '上下文',
      buildPreview: '10 步沙盒構建流程',
      automatePreview: '透過 Hermes 安排週期工作',
      newIntent: '新的意圖',
      attachment: '{count} 個附件',
      historyPalette: '對話歷史面板',
      historyTitle: '對話歷史',
      noRecentChats: '尚無近期對話',
      untitledIntent: '未命名意圖',
      summonPalette: '代理召喚面板',
      summon: '召喚',
      skillsPalette: '技能與插件面板',
      skillsTitle: '技能與插件',
      loadingSkills: '正在載入可用技能與插件...',
      noMatchingSkills: '沒有符合的技能或插件',
      slashLoadError: '部分技能或插件無法載入。',
      useSkillContext: '將此技能作為意圖上下文',
      usePluginContext: '將此插件作為意圖上下文',
      quantWatching: 'Hermes 正在關注',
      agent: '代理',
      channel: '頻道',
      commanderDesc: '透過 Aurora Commander 路由意圖',
      quantDesc: '市場快照、Top 10、Paper Trading',
      lifeosDesc: 'FIRE、預算、淨資產儀表板',
      memoryDesc: '搜尋或提議受治理記憶',
      kanbanDesc: '任務、看板、執行狀態',
      groupDesc: '召喚多代理討論',
      recent: '最近',
    },
  },
  ...
  chat: {
    ...
    historyScopeHint: '這裡按來源查看 Hermes 歷史工作階段，可刪除不需要的紀錄。',
    noSessions: '目前無工作階段',
    searchTitle: '搜尋工作階段',
  ...
  plugins: {
    title: '插件',
    refresh: '重新整理',
    notice: '這裡會掃描可發現的 Hermes 插件 manifest，掃描元資料時不載入插件程式碼。使用者插件現在可以直接安裝、啟用、停用、更新或移除；變更會在新的 Hermes 工作階段生效。',
    loadFailed: '載入插件失敗',
    commandCopied: '指令已複製',
    installPlaceholder: 'Git URL 或 owner/repo',
    install: '安裝',
    installEnable: '安裝後啟用',
    installForce: '覆寫既有插件',
    installMissing: '請輸入插件 Git URL 或 owner/repo。',
    installSucceeded: '插件已安裝：{name}',
    enableAction: '啟用',
    disableAction: '停用',
    updateAction: '更新',
    removeAction: '移除',
    removeConfirm: '要從使用者插件移除「{name}」嗎？',
    actionSucceeded: '插件動作已完成：{name}',
    operationFailed: '插件操作失敗',
    changesNextSession: '變更會在新的 Hermes 工作階段生效。',
    missingEnv: '缺少環境變數：{names}',
