export default {
  ...
  profiles: {
    ...
    thinkingAnimation: {
      ...
      save: '儲存',
      reset: '使用預設',
      hint: 'GIF、WebP、MP4 或 WebM。最大 5MB。',
      invalidType: '請選擇 GIF、WebP、MP4、WebM 或圖片檔案',
      tooLarge: '動畫檔案必須小於 5MB',
      saveSuccess: '思考動畫已儲存',
      saveFailed: '儲存思考動畫失敗',
      resetSuccess: '已恢復預設思考動畫',
      resetFailed: '恢復預設思考動畫失敗',
      urlPlaceholder: '貼上圖片/影片 URL，留空則使用預設',
      noPreview: '未設定自訂動畫',
      enableThinking: '啟用思考動畫',
      delete: '刪除動畫',
      maxReached: '已達到最大數量 {max} 個',
      savedItems: '已儲存 {count} 個動畫',
    },
    runtime: {
