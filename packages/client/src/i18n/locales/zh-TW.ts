export default {
  ...
  sidebar: {
    ...
    collapse: '收起選單',
    expand: '展開選單',
    updateTip: '在終端機執行 "audbuild update" 即可更新',
  ...
  chat: {
    ...
    openHistory: '開啟歷史',
    hermesHistory: 'audbuild 歷史',
    historyScopeHint: '這裡按來源以唯讀方式查看 audbuild 歷史工作階段。',
    noSessions: '目前無工作階段',
    searchTitle: '搜尋工作階段',
  ...
  plugins: {
    title: '插件',
    refresh: '重新整理',
    notice: '唯讀顯示可發現的 audbuild 插件 manifest。發現元資料讀取不會載入插件程式碼。v1 管理動作仍保留在 CLI，新 audbuild 工作階段生效。',
    loadFailed: '載入插件失敗',
    commandCopied: '指令已複製',
  ...
  models: {
    ...
    copilotAddDetected: '已在本機偵測到 GitHub Copilot OAuth 憑證，點擊「新增」即可在 audbuild 中啟用 Copilot。',
    ...
    copilotDeleteHintGhCli: 'Copilot 將從 audbuild 清單移除。不會影響 gh CLI —— `gh auth status` 仍顯示已登入。',
    copilotDeleteHintAppsJson: 'Copilot 將從 audbuild 清單移除。不會影響 VS Code Copilot 插件的登入。',
    customBadge: '自訂',
    previewBadge: '預覽',
    disabledBadge: '不可用',
    ...
    visibilityHint: '僅影響 Web UI 的模型選擇器和模型頁展示，不會改寫 audbuild CLI 的 provider/model 配置。實際呼叫仍使用原始模型 ID。',
    ...
    aliasHint: '僅修改 Web UI 顯示名，傳送給 audbuild 的仍是原始模型 ID。',
  ...
  skillsUsage: {
    title: '技能用量',
    subtitle: '追蹤 audbuild 工作階段中的技能載入與編輯',
    refresh: '重新整理',
  ...
  changelog: {
    ...
    new_0_5_15_9: '修復 audbuild Markdown 媒體渲染與同步重試',
    new_0_5_15_10: '重構移除上游環境變數依賴',
    new_0_5_15_11: '如果看板功能無法使用，請升級 audbuild',
    ...
    new_0_5_17_9: '新增唯讀 audbuild 外掛頁',
    ...
    new_0_5_22_1: '修復 audbuild 會話列表介面錯誤讀取 Web UI 本地會話庫的問題',
    ...
    new_0_5_5_2: '新增歷史頁面，用於瀏覽 audbuild 工作階段歷史記錄',
    ...
    new_0_5_4_3: '修復 Docker 部署後 Web 終端機無法使用 audbuild CLI 的問題',
    new_0_5_4_4: '新增工作區對話框標題 i18n 翻譯，改進工作階段持久化',
    new_0_5_4_5: '支援程式碼區塊複製回饋，顯示使用者通知',
    new_0_5_4_6: '對齊使用分析與 audbuild 狀態資料庫架構',
    ...
    new_0_4_8_10: '上傳目錄從暫存目錄遷移到 ~/.audbuild/upload',
