export default {
  ...
  runtimeVersions: {
    ...
    runtimeDirectoryHint: '下次重新啟動時會在本機服務啟動前複製並驗證目前 Runtime，舊目錄會保留。',
    runtimeDirectorySaved: 'Runtime 遷移已排程，重新啟動 Hermes Studio 後執行。',
    runtimeMigrationPending: '待遷移至：{directory}',
    runtimeMigrationFailed: 'Runtime 遷移失敗，已繼續使用原 Runtime',
    active: '已啟用',
    installed: '已安裝',
    download: '下載',
  ...
  changelog: {
    ...
    new_0_6_31_12: '版本管理現在可以遷移 Runtime 儲存目錄；下次重新啟動時會在服務啟動前完成複製驗證，並保留舊副本作為回復（#2134）',
