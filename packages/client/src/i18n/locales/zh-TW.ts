export default {
  ...
  settings: {
    ...
    voice: {
      ...
      clearStoredKey: '清除已儲存 key',
      storedServerKey: '服務端已儲存 key：{value}',
      secretPendingSave: '儲存時更新',
      storedOnServer: '已儲存在服務端',
      saveTtsSettings: '儲存 TTS 設定',
      webspeechSettingsSaved: 'WebSpeech 設定已儲存到本機。',
      ttsSettingsSaved: 'TTS 設定已儲存到服務端。',
      ttsSettingsSaveFailed: '儲存 TTS 設定失敗。',
      storedSecretCleared: '服務端 TTS secret 已清除。',
      storedSecretClearFailed: '清除服務端 TTS secret 失敗。',
      mimoCloneAudioInvalid: 'MiMo 複刻音訊必須是 mp3 或 wav 檔案。',
      mimoCloneAudioTooLarge: 'MiMo 複刻音訊不能超過 10 MB。',
      mimoCloneAudioReadFailed: '讀取音訊檔案失敗。',
      mimoCloneAudioCleared: '服務端 MiMo 複刻音訊已清除。',
      mimoCloneAudioClearFailed: '清除服務端 MiMo 複刻音訊失敗。',
