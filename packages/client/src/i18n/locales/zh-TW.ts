export default {
  ...
  groupCollab: {
    title: '群協作',
    newRoom: '新建群協作',
    roomKindHint: '@ 一位協調者並描述任務，系統會拆解為子任務並分派給各數位人並行執行',
    emptyHint: '在下方 @ 一位協調者並描述複雜任務，即可開啟一次多角色協作',
    board: {
      title: '協作任務看板',
      workspace: '工作目錄',
      coordinator: '協調者',
      rootTask: '統籌匯總',
      children: '子任務',
      progress: '{done}/{total} 個子任務已完成',
      noTasks: '正在等待協調者拆解子任務…',
      parallelHint: '同一層級的任務由不同數位人並行執行',
      laneTaskCount: '{count} 個任務',
      blockedReason: '阻塞原因：',
      viewLog: '執行日誌',
      hideLog: '收起',
      logEmpty: '該任務尚無執行日誌（worker 可能還未啟動）',
      logLoading: '正在讀取執行日誌…',
      logFailed: '讀取執行日誌失敗',
      summary: '執行結果',
      unassigned: '未分派',
    ...
    notice: {
      coordinatorUnresolved: '請 @ 一位協調者來承接這個任務',
      goalEmpty: '請描述需要協作完成的任務',
      startFailed: '協作任務建立失敗，請檢查 Hermes 看板服務',
      stopFailed: '停止協作失敗',
    },
  },
  groupChat: {
