...
export default {
  dshPlugins: {
    ...
    "noEntries": "沒有外掛項目",
    "conditional": "依條件啟用",
    "additionalPackages": "額外安裝的 ACP 套件",
    "title": "外掛管理",
    "packages": "套件",
    "install": "安裝",
    "update": "更新",
    ...
    "succeeded": "成功",
    "failed": "失敗",
    "description": "Studio 管理的原生 ACP 外掛套用於各對話後續的 DSH 啟動，執行中的程序保留原版本。暫不支援瀏覽器端外掛。",
    "installHint": "請輸入 套件名稱{'@'}精確版本。安裝指令碼不會執行，新外掛組合需手動啟用。僅安裝可信套件。",
    "removeConfirm": "從後續啟動中移除 {name}？",
    "runtimeUnknown": "僅顯示設定狀態，尚未驗證執行健康狀態與相容性。",
    "entries": "宣告的外掛項目",
    "discard": "放棄草稿並載入最新已儲存設定？",
    "configHint": "YAML 修補在已啟用的外掛組合之後套用，下次啟動 DSH 時生效。",
    "rollbackConfirm": "後續啟動使用此保留版本？",
    "conflict": "設定已被其他操作修改。草稿已保留，請比較最新版本後重新載入。",
    "missingDependency": "請先安裝 DSH 與 pnpm。",
    "busy": "有操作正在進行，或套件狀態衝突。請重新整理後再試。",
    "interrupted": "操作中斷，保留先前的有效版本。",
    "unsupported": "原生 ACP 管理暫不支援此套件或功能。",
    "invalid": "請檢查套件精確版本或 YAML 修補序列。",
    "timeout": "操作逾時，保留先前的有效版本。"
},
