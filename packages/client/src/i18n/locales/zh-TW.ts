export default {
  ...
  groupChat: {
    ...
    triggerTokensDesc: 'Room 上限；系統會依每個參與者的模型上下文視窗自動採用較低的安全閾值',
    maxHistoryTokens: '最大歷史 Token 數',
    maxHistoryTokensDesc: '壓縮後歷史的上限；系統會隨參與者的有效觸發閾值自動降低',
    ...
    roomSettings: '房間設定',
    handoffMode: '接力模式',
    handoffModeMentions: '依 Agent 輸出提及',
    handoffModeFixed: '固定參與者順序',
    fixedHandoffOrder: '固定接力順序',
    invalidFixedHandoffOrder: '固定接力順序至少需要兩位不重複的參與者',
    invalidParticipantChain: '參與者接力鏈無效。請使用「@參與者 → @參與者」並確保參與者存在於目前 Room。',
    participantChainPreview: '固定接力鏈：',
    moveHandoffUp: '上移',
    moveHandoffDown: '下移',
    handoffPending: '接力待處理',
    handoffRunning: '接力執行中',
    handoffFailed: '接力失敗',
    handoffInterrupted: '接力已中斷',
    activityDock: '目前活動',
    activityStep: '第 {step}/{total} 步',
    viewHandoffProgress: '查看進度',
    stopHandoff: '停止整條接力',
    stopReply: '停止 {agent} 目前回覆',
    stoppingActivity: '正在停止...',
