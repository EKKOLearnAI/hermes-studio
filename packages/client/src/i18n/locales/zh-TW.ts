export default {
  ...
  changelog: {
    ...
    new_0_5_18_1: '新增 Skills Usage 監控頁，包含每日趨勢圖和熱門 skill 統計',
    new_0_5_18_2: '新增 CLI 聊天工作階段 Bridge，透過 Python agent bridge 支援 WebSocket 工作階段',
    new_0_5_18_3: '新增 Ollama Cloud Provider 預設，支援動態模型目錄',
    new_0_5_18_4: '支援模型顯示名稱重新命名（別名）',
    new_0_5_18_5: '支援在 Web UI 管理模型可見性',
    new_0_5_18_6: '增強用量分析儀表板',
    new_0_5_18_7: '支援 docker-compose 的 Docker 單容器部署，並修復 gateway 啟動問題',
    new_0_5_18_8: '修復非預設 Profile 下 plugins 頁面的 HERMES_HOME fallback 警告',
    new_0_5_18_9: '修復開發重啟時的 gateway 穩定性並改善 Windows 相容性',
