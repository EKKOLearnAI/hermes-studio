export default {
  ...
  chat: {
    ...
    approvalModeTooltip: '本會話的審批模式——危險命令如何被批准',
    approvalModeManual: '手動',
    approvalModeSmart: '智慧',
    approvalModeOff: '完全授權',
    approvalModeOffConfirmTitle: '開啟完全授權？',
    approvalModeOffConfirmContent: '本會話將跳過所有審批彈窗——包括危險命令在內全部自動批准（自訂拒絕規則仍然生效）。確定繼續？',
    approvalModeOffConfirmOk: '開啟',
    approvalModeOffConfirmCancel: '取消',
    slashCommandArgs: {
      message: '<訊息>',
      title: '<標題>',
      text: '<文字>',
    ...
    slashCommands: {
      ...
      approvalModeManual: '手動審批',
      approvalModeSmart: 'AI 智慧審批',
      approvalModeOff: '完全授權（跳過所有審批）',
