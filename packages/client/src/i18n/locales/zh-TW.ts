export default {
  ...
  changelog: {
    ...
    new_0_6_37_2: '群聊房間現在使用全新隔離執行，將每則回覆與其 reasoning 和工具過程分組顯示，並加入共享可編輯滾動摘要、摘要狀態與邊界、Agent mention、房間及 workspace 抽屜和舊房間遷移提示。語音自動播放會依訊息順序阻塞排隊，並使用回覆 Agent 所屬 Profile 的 TTS 設定產生，新回覆不再覆蓋正在播放的語音（#2334）',
