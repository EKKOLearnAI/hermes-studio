export default {
  ...
  sidebar: {
    ...
    expand: 'Expand menu',
    updateTip: 'Run "audbuild update" in terminal to update',
  ...
  chat: {
    ...
    emptyState: 'Start a conversation with audbuild',
    ...
    hermesHistory: 'audbuild History',
    historyScopeHint: 'Read-only audbuild history sessions grouped by source.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Refresh',
    notice: 'Read-only inventory of discoverable audbuild plugin manifests. Discovery metadata is read without loading plugin code. Management actions stay in CLI for v1; changes take effect in new audbuild sessions.',
  ...
  models: {
    ...
    copilotAddDetected: 'A GitHub Copilot OAuth token was detected on this machine. Click Add to enable Copilot in audbuild.',
    ...
    copilotDeleteHintGhCli: 'Copilot will be hidden from audbuild. Your gh CLI login is not affected — `gh auth status` will still show you signed in.',
    copilotDeleteHintAppsJson: 'Copilot will be hidden from audbuild. Your VS Code Copilot extension login is not affected.',
    customBadge: 'CUSTOM',
    ...
    aliasHint: 'Display-only alias. audbuild still receives the canonical model ID.',
    ...
    visibilityHint: 'Only affects the Web UI model picker and Models page. audbuild CLI provider/model config is not rewritten; calls still use canonical model IDs.',
  ...
  skillsUsage: {
    title: 'Skills Usage',
    subtitle: 'Track skill loads and edits from audbuild sessions',
    refresh: 'Refresh',
  ...
  changelog: {
    ...
    new_0_5_15_9: 'Fix audbuild markdown media rendering and sync retry',
    new_0_5_15_10: 'Refactor to remove upstream env dependency',
    new_0_5_15_11: 'If the Kanban feature is not available, please upgrade audbuild',
    ...
    new_0_5_17_9: 'Add read-only audbuild plugins page',
    ...
    new_0_5_5_2: 'Add History page for browsing audbuild session history',
    ...
    new_0_5_4_3: 'Fix web terminal audbuild CLI availability after Docker deployment',
    ...
    new_0_5_4_6: 'Align usage analytics with audbuild state DB schema',
