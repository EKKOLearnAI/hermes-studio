export default {
  ...
  login: {
    ...
    defaultLoginResetHint: 'To reset the default quanthermes password, run:',
  ...
  sidebar: {
    ...
    expand: 'Expand menu',
    updateTip: 'In customized builds, upgrades are managed by your internal release process',
    updateVersion: 'Upgrade to v{version}',
    reloadClientVersion: 'Reload for v{version}',
    updating: 'Updating...',
    updateSuccess: 'Update successful. Please refresh the page shortly. If it does not start after a while, restart it manually.',
  ...
  chat: {
    ...
    hermesHistory: 'QuantHermes History',
    historyScopeHint: 'Read-only QuantHermes history sessions grouped by source.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Refresh',
    notice: 'Read-only inventory of discoverable QuantHermes plugin manifests. Discovery metadata is read without loading plugin code. Management actions stay in CLI for v1; changes take effect in new QuantHermes sessions.',
  ...
  models: {
    ...
    copilotAddDetected: 'A GitHub Copilot OAuth token was detected on this machine. Click Add to enable Copilot in QuantHermes.',
    ...
    copilotDeleteHintGhCli: 'Copilot will be hidden from QuantHermes. Your gh CLI login is not affected — `gh auth status` will still show you signed in.',
    copilotDeleteHintAppsJson: 'Copilot will be hidden from QuantHermes. Your VS Code Copilot extension login is not affected.',
    customBadge: 'CUSTOM',
  ...
  skillsUsage: {
    title: 'Skills Usage',
    subtitle: 'Track skill loads and edits from QuantHermes sessions',
    refresh: 'Refresh',
  ...
  changelog: {
    ...
    new_0_6_0_7: 'Add CLI maintenance commands for clearing login IP locks and resetting the default quanthermes / 12345678 login',
