...
export default {
  dshPlugins: {
    ...
    "nativeHint": "Studio ACP loads backend plugins and the default agent preset from your DSH Web profile. This list previews shipped and user presets; changing this selector does not change the default. Browser interfaces and live Web status are not connected.",
    ...
    "additionalPackages": "Additional ACP packages",
    "title": "Plugins",
    "packages": "Packages",
    "install": "Install",
    "update": "Update",
    ...
    "reload": "Reload",
    "latest": "Latest saved configuration",
    ...
    "succeeded": "Succeeded",
    "failed": "Failed",
    "description": "Studio-managed native ACP plugins apply to new DSH launches across chats. Running processes retain their version. Browser integration is not available yet.",
    "installHint": "Use package{'@'}exact-version. Installation scripts are disabled; new bundles require explicit activation. Install only packages you trust.",
    "removeConfirm": "Remove {name} from future launches?",
    "runtimeUnknown": "Configuration state only; runtime health and compatibility have not been verified.",
    "entries": "Declared plugin entries",
    "discard": "Discard the draft and load the latest saved configuration?",
    "configHint": "YAML patch applied after enabled bundles. Changes take effect on the next DSH launch.",
    "rollbackConfirm": "Use this retained version for future launches?",
    ...
    "busy": "Another operation is running, or the requested package state conflicts. Refresh and retry.",
    "interrupted": "Operation interrupted. The previous active version is retained.",
    "unsupported": "This package or capability is not supported in native ACP management.",
    "invalid": "Check the exact package version or YAML patch sequence.",
    "timeout": "Operation timed out. The previous active version is retained."
},
