export default {
  ...
  settings: {
    ...
    voice: {
      ...
      storedServerKey: 'Stored server key: {value}',
      secretPendingSave: 'will be updated on save',
      storedOnServer: 'Stored on server',
      saveTtsSettings: 'Save TTS settings',
      webspeechSettingsSaved: 'WebSpeech settings saved locally.',
      ttsSettingsSaved: 'TTS settings saved on server.',
      ttsSettingsSaveFailed: 'Failed to save TTS settings.',
      storedSecretCleared: 'Stored TTS secret cleared from server.',
      storedSecretClearFailed: 'Failed to clear stored TTS secret.',
      mimoCloneAudioInvalid: 'MiMo clone audio must be an mp3 or wav file.',
      mimoCloneAudioTooLarge: 'MiMo clone audio must be 10 MB or smaller.',
      mimoCloneAudioReadFailed: 'Failed to read audio file.',
      mimoCloneAudioCleared: 'Stored MiMo clone audio cleared from server.',
      mimoCloneAudioClearFailed: 'Failed to clear stored MiMo clone audio.',
