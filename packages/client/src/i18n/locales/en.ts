export default {
  ...
  updates: {
    title: 'Updates',
    subtitle: 'Live, preview, and developer source controls',
    refresh: 'Refresh',
    updating: 'Updating...',
    currentStableTitle: 'Live',
    installedVersion: 'Version',
    updateStatus: 'Update status',
    connected: 'Connected',
    disconnected: 'Disconnected',
    sourceUnavailableTitle: 'Live source unavailable',
    sourceUnavailableBody: 'This installation is not reporting live status.',
    ...
    previewBody: 'Preview the next build before you switch live.',
    previewStableCopy: 'Live stays unchanged unless you click Preview → Live.',
    ...
    updateStableTo: 'Update live to v{version}',
