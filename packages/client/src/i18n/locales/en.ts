export default {
  ...
  models: {
    ...
    codexManageTitle: 'Codex Account Management',
    codexManageDesc: 'Add accounts via browser device-code login, then switch or delete accounts.',
    codexAddAccount: 'Add Account (Codex Login)',
    codexNoAccounts: 'No Codex accounts yet. Click “Add Account” to start.',
    codexActiveAccount: 'Active account:',
    codexActive: 'Active',
    codexSwitch: 'Switch',
    codexSwitchSuccess: 'Account switched',
    codexSwitchFailed: 'Failed to switch account',
    codexDeleteTitle: 'Delete Account',
    codexDeleteConfirm: 'Delete account "{name}"?',
    codexDeleteSuccess: 'Account deleted',
    codexDeleteFailed: 'Failed to delete account',
    codexLoadFailed: 'Failed to load Codex status',
    codexLoginFailed: 'Failed to start Codex login',
    codexPollFailed: 'Failed to poll login status',
    codexNotEnabledHint: 'Codex provider will appear after first successful login.',
