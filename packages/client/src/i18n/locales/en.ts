...
export default {
  ...
  agentManager: {
    ...
    cursorNoManagedConfig: 'Cursor MCP servers are stored in ~/.cursor/mcp.json. Edit them in the MCP panel. Studio merges managed servers into that file because the CLI has no --mcp-config flag.',
  ...
  connections: {
    ...
    app: {
      ...
      pushForDevice: "Push notifications for {name}",
      pushUpdateFailed: "Failed to update push notifications",
      online: 'Online',
      offline: 'Offline',
      active: 'Active',
      expired: 'Expired',
