...
export default {
  ...
  personalOS: {
    ...
    quickLog: 'Quick Log',
    quickLogPlaceholder: 'Record diet, training, skin, or state in one sentence',
    quickLogSubmit: 'Log',
    quickLogSaved: 'Logged',
    quickLogFailed: 'Log failed',
    weixinReminders: 'Weixin Reminders',
    weixinReminderOn: 'Enabled',
    weixinReminderOff: 'Disabled',
    weixinReminderSummary: 'Only push the current best action, with quiet hours, dedupe, and daily limits.',
    weixinReminderEnabled: 'Weixin reminders enabled',
    weixinReminderDisabled: 'Weixin reminders disabled',
    weixinReminderUpdateFailed: 'Failed to update Weixin reminders',
    weixinReminderTest: 'Send Test',
    weixinReminderTestSent: 'Test reminder sent',
    weixinReminderTestFailed: 'Test reminder failed',
    quietHours: 'Quiet Hours',
    dailyLimit: 'Daily Limit',
    lastReminder: 'Last Delivery',
    openFullPlan: 'Open Full Plan',
    openHealth: 'Open Health',
    systems: {
      kicker: 'Full Systems',
      title: 'Deep Management',
      summary: 'Weixin stays lightweight. Planning, fitness, diet, skin, and health data remain complete systems inside Hermes.',
      planning: {
        title: 'Planning System',
        summary: 'Maintain long-term goals, schedule, and today actions.',
      },
      fitness: {
        title: 'Fitness System',
        summary: 'Training, logs, body posture, and recovery.',
      },
      diet: {
        title: 'Diet System',
        summary: 'Nutrition gaps, food logs, and supplement execution.',
      },
      skin: {
        title: 'Skin System',
        summary: 'Skin state, skincare execution, and triggers.',
      },
      health: {
        title: 'Health Data',
    ...
    noTasks: 'No Personal State tasks',
    noProposals: 'No proposals yet',
    emptyMemory: 'No Personal State records have been recorded yet.',
    loadFailed: 'Failed to load Personal State',
  ...
  health: {
    ...
    scaleReading: 'Latest Scale Reading',
    scale: {
      bodyFat: 'Body Fat',
    ...
    scaleSync: {
      title: 'Scale Sync',
      settingsTitle: 'Xiaomi Health / Mi Home Scale',
      settingsSummary: 'Automatically sync S400 scale data from Mi Home or Mi Fitness.',
      enabled: 'Enable Sync',
      enabledHint: 'Enabled by default. If setup is incomplete, Hermes waits for connection without blocking the health page.',
      source: 'Source',
      sourceHint: 'For mainland China S400, Mi Home with region cn is preferred.',
      username: 'Xiaomi Account',
      usernameHint: 'Used only to read your own scale data and stored in the local Hermes profile.',
      password: 'Xiaomi Password',
      passwordHint: 'The saved password is never echoed back to the frontend.',
      passwordConfigured: 'Password is saved. Leave blank to keep the existing password.',
      region: 'Region',
      regionHint: 'Use cn for mainland China.',
      scaleModel: 'Scale Model',
      scaleModelHint: 'Your Mi Home S400 is currently identified as yunmai.scales.ms103.',
      path: 'Sync Executor Path',
      executor: 'Sync Executor',
      executorHint: 'Usually installed or detected by Hermes. Only set scaleconnect.exe manually if auto-detection fails.',
      runNow: 'Sync Now',
      openVerification: 'Open Xiaomi Verification',
      ready: 'Configured',
      notReady: 'Not Configured',
      synced: 'Imported',
      healthReadySummary: 'Hermes will automatically try to sync scale data. You can also trigger a manual sync.',
      healthNotReadySummary: 'Sync is enabled by default, but the account, password, or local executor is still missing. Finish setup under Settings > Integrations.',
      loadFailed: 'Failed to load scale sync settings',
      saveFailed: 'Failed to save scale sync settings',
      runFailed: 'Failed to run scale sync',
      reason: {
        disabled: 'Sync is disabled',
        missing_xiaomi_credentials: 'Missing Xiaomi account or password',
        missing_scaleconnect_path: 'Missing SmartScaleConnect path',
        scaleconnect_not_found: 'SmartScaleConnect was not found',
        scaleconnect_failed: 'SmartScaleConnect failed',
        scaleconnect_load_data_failed: 'Failed to load scale data',
        xiaomi_identity_verification_required: 'Xiaomi account identity verification is required',
      },
    },
    tabs: {
      overview: 'Overview',
    ...
    loop: {
      readiness: {
        ...
        summary: 'Review the next safe action before opening detailed health views.',
        primary: 'Next action',
      ...
      actions: {
        ...
        capture: 'Capture health data',
        review: 'Review active plan',
      },
      domains: {
        title: 'Domain freshness',
        eightDomains: '8 health domains',
      ...
      freshness: { current: 'Current', missing: 'Waiting for data', unavailable: 'No connector' },
      connectors: { errors: 'Connector errors' },
      interventions: {
        title: 'Active intervention',
        activeCount: '{count} active',
        empty: 'No active intervention. Hermes remains in observation mode.',
        riskAuthority: 'Risk: {risk} · Authority: {authority}',
        categories: { training: 'Training', recovery: 'Recovery', nutrition: 'Nutrition', posture: 'Posture', skin: 'Skin', internal_health: 'Internal health' },
      },
      workflow: {
        draft: 'Draft', policy_check: 'Policy check', preparing: 'Preparing', executing: 'Executing', verifying: 'Verifying',
        waiting_user: 'Waiting for confirmation', retrying: 'Retrying', compensating: 'Compensating', succeeded: 'Succeeded',
        denied: 'Denied', cancelled: 'Cancelled', failed: 'Failed', dead_letter: 'Needs manual review', compensated: 'Compensated',
        confirmationRequired: 'This workflow requires your confirmation.',
        actions: { approve: 'Approve', reject: 'Reject', cancel: 'Cancel', retry: 'Retry', compensate: 'Undo' },
      },
      feedback: { title: 'Outcome feedback', completed: 'Completed', partial: 'Partly completed', deferred: 'Defer', adverse_feedback: 'Adverse response' },
      capture: {
        title: 'Capture and review',
        localFirst: 'Local first',
        requirementFormat: 'Use a supported image, PDF, JSON, CSV, or text export.',
        requirementPrivacy: 'Only reviewed extracted values are sent for analysis.',
        requirementReview: 'Check every extracted value before granting consent.',
        fileLabel: 'Choose a health artifact',
        processorLabel: 'Processor',
        selectProcessor: 'Select a processor',
        extractedValues: 'Extracted-value review',
        noExtractedValues: 'Values will appear here for review after capture.',
        continue: 'Upload for review',
        uploading: 'Uploading…',
      },
      consent: {
        title: 'Review analysis consent',
        oneTime: 'One-time consent manifest',
        summary: 'This consent applies only to the listed artifacts, fields, purpose, processor, and retention.',
        processor: 'Processor', purpose: 'Purpose', artifacts: 'Artifacts', regions: 'Regions', fields: 'Fields', retention: 'Retention',
        confirm: 'Grant once and analyze', processing: 'Analyzing…',
      },
      automation: {
        title: 'Health automation',
        summary: 'Shadow mode evaluates delivery without sending a live Weixin message.',
        shadow: 'Shadow', live: 'Live',
        confirmationLabel: 'Type {code} to enable live Weixin delivery.',
        liveWeixin: 'Enable live Weixin',
        returnShadow: 'Return to shadow mode',
      },
      errors: { actionFailed: 'Health action failed' },
    },
  },

  fitness: {
    title: 'Fitness System',
    subtitle: 'Manage training plans, workout logs, body posture, and recovery as a complete system.',
    todayFocus: 'Today Training Focus',
    todayFocusFallback: 'No training note for today. Review logs and recovery first.',
    ...
    energy: 'Energy',
    pain: 'Pain',
    noTodayWorkout: 'No training planned for today',
    noWorkoutLogs: 'No workout logs yet',
    noBodyFocus: 'No body or posture focus yet',
    noRecoveryNote: 'No recovery note yet',
    loadFailed: 'Failed to load fitness system',
    tabs: {
      today: 'Today Training',
      plan: 'Training Plan',
      logs: 'Workout Logs',
      body: 'Body Posture',
      recovery: 'Recovery',
  ...
  devices: {
    ...
    unblock: 'Unblock',
    healthDevice: {
      summary: 'Raw body scale data synced from Xiaomi Home into Hermes.',
      connected: 'Connected',
      notConfigured: 'Not configured',
      loading: 'Loading scale data',
      noData: 'No scale data yet',
      loadFailed: 'Failed to load health device',
      syncFailed: 'Failed to sync health device',
      syncedCount: 'Synced {count} records',
      syncNow: 'Sync now',
      openHealth: 'Open health system',
