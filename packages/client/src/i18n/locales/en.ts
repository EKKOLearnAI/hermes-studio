export default {
  ...
  login: {
    ...
    tokenLogin: 'Token',
    feishuLogin: 'Log in with Feishu',
    ...
    feishuUatTitle: 'Authorize Feishu tools',
    feishuUatDescription: 'Complete Feishu authorization so Hermes can use Feishu APIs as you.',
    feishuUatOpen: 'Open Feishu authorization',
    feishuUatFailed: 'Feishu authorization failed',
  },
  ...
  sidebar: {
    ...
    feishuConnected: 'Feishu connected',
    feishuNotConnected: 'Feishu not connected',
    feishuChecking: 'Checking Feishu connection',
    feishuConnecting: 'Connecting Feishu',
    feishuConnectFailed: 'Feishu connection failed',
  ...
  chat: {
    ...
    tooManySessionsInGroup: 'Showing {shown} of {total} — use search to find older conversations',
    historyEmptyTitle: 'No history for this profile',
    historyEmptyHint: 'Sessions from the Hermes profile bound to this login will appear here after CLI, Feishu, or other channels create records.',
  ...
  jobs: {
    ...
    gatewayUnavailable: 'Task service is connecting',
    gatewayUnavailableHint: 'The job list is temporarily unavailable. The system is connecting this profile task service; retry shortly.',
    name: 'Name',
  ...
  settings: {
    ...
    userMode: {
      title: 'User mode',
      description: 'Only personal Agent settings are available here. Account, model, channel, gateway, logs, and user management belong to the ops plane and cannot be viewed or changed from this screen.',
    },
    display: {
      ...
      showTokenUsageHint: 'Show token usage for each reply',
  ...
  groupChat: {
    title: 'Group Chat',
    userModeTitle: 'Group Chat beta is not open yet',
    userModeDescription: 'User mode is currently locked to the personal profile. Rooms need backend ownership, invite scope, and cross-profile Agent ACL before this opens.',
    ...
    clearContextConfirm: 'Clear this room message history and compressed context? Members, agents, and config will be kept.',
  ...
  usage: {
    ...
    noDataHint: 'This profile does not have usage-bearing sessions yet.',
  },
  // Files
  files: {
    title: 'Files',
    workspaceScope: 'Profile workspace',
    workspaceFolders: '{count} folders',
    workspaceFiles: '{count} files',
    workspaceCurrentPath: 'Path: {path}',
    fileTree: 'File Tree',
    tree: 'Directory Tree',
    list: 'File List',
    breadcrumbRoot: 'Home',
