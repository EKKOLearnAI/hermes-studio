...
export default {
  ...
  groupCollab: {
    ...
    board: {
      ...
      hideLog: 'Hide',
      logEmpty: 'No execution log yet (the worker may not have started)',
      logLoading: 'Loading execution log…',
      logFailed: 'Failed to read the execution log',
      summary: 'Result',
      unassigned: 'Unassigned',
      elapsed: '{value} elapsed',
      openKanban: 'Open in Kanban',
    },
    status: {
      creating: 'Creating the collaboration task',
      decomposing: 'Coordinator is splitting the goal',
      running: 'Collaboration in progress',
      done: 'Collaboration complete',
      failed: 'Collaboration interrupted',
    },
    taskStatus: {
      triage: 'Triage',
      todo: 'To do',
    ...
    notice: {
      coordinatorUnresolved: 'Mention a coordinator to own this task',
      goalEmpty: 'Describe the goal you want the team to work on',
      startFailed: 'Could not create the collaboration task — check the Hermes Kanban service',
      stopFailed: 'Failed to stop collaboration',
    },
  },
  groupChat: {
