export default {
  ...
  chat: {
    ...
    dragToPosition: 'Drag to position · Scroll or slider to zoom',
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimationHint: 'Customize the animation shown while AI is processing',
      taCustomLoaded: 'Custom animation loaded',
      taDefault: 'Using default animation',
      taChange: 'Change',
      taUpload: 'Upload Animation',
      taResetDefault: 'Reset to Default',
      taUploadReq: 'Upload Requirements',
      taFormat: 'Format: GIF, MP4, WebM, MOV, AVI, MKV',
      taSize: 'Size: ≤ 20MB',
      taDuration: 'Duration: Any (auto-trimmed to 3s)',
      taResolution: 'Resolution: Any',
      taConvertHint: 'Non-MP4/GIF formats auto-convert via ffmpeg',
      taFileTooLarge: 'File too large (max 20MB)',
      taUploadFailed: 'Upload failed',
      taResetFailed: 'Reset failed',
      theme: 'Theme',
  ...
  changelog: {
    ...
    new_0_4_3_1: 'Add cross-machine profile support with BFF proxy routing',
    new_0_4_3_2: 'Add session search with keyword matching',
    new_0_4_3_3: 'Add context usage tracking and token display',
    new_0_4_3_4: 'Add provider-aware context length lookup',
    new_0_4_1_1: 'Initial release of Hermes Web UI with chat, models, and sessions',
  },
  // Gateway Tabs
  gatewayTabs: {
    ...
    rename: 'Rename',
    renamed: 'Renamed profile "{from}" to "{to}"',
    renameFailed: 'Failed to rename profile',
