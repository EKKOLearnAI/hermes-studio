export default {
  ...
  runtimeVersions: {
    ...
    runtimeDirectoryHint: 'The current Runtime will be copied and verified before local services start on the next restart. The old copy is retained.',
    ...
    runtimeMigrationFailed: 'Runtime migration failed; the previous Runtime is still in use',
    active: 'Active',
    installed: 'Installed',
    download: 'Download',
  ...
  changelog: {
    ...
    new_0_6_31_12: 'Version Management can now relocate Runtime storage; migration runs before services start on the next restart and keeps the previous copy as a fallback (#2134)',
