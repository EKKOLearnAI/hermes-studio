export default {
  ...
  chat: {
    ...
    historyScopeHint: 'Hermes history sessions grouped by source. Delete records you no longer need.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Refresh',
    notice: 'Discoverable Hermes plugin manifests are scanned without loading plugin code. User plugins can now be installed, enabled, disabled, updated, or removed here; changes take effect in new Hermes sessions.',
    loadFailed: 'Failed to load plugins',
    commandCopied: 'Command copied',
    installPlaceholder: 'Git URL or owner/repo',
    install: 'Install',
    installEnable: 'Enable after install',
    installForce: 'Overwrite existing',
    installMissing: 'Enter a plugin Git URL or owner/repo.',
    installSucceeded: 'Plugin installed: {name}',
    enableAction: 'Enable',
    disableAction: 'Disable',
    updateAction: 'Update',
    removeAction: 'Remove',
    removeConfirm: 'Remove "{name}" from user plugins?',
    actionSucceeded: 'Plugin action completed: {name}',
    operationFailed: 'Plugin operation failed',
    changesNextSession: 'Changes take effect in new Hermes sessions.',
    missingEnv: 'Missing environment variables: {names}',
