export default {
  ...
  models: {
    ...
    geminiLoginTitle: 'Google Gemini Login',
    geminiWaiting: 'Complete authorization in the opened Google page. This window will close automatically once approved.',
    geminiPolicyNotice: 'This uses Gemini CLI / Cloud Code Assist OAuth. For the lowest-risk official path, use Google AI Studio with GOOGLE_API_KEY.',
    geminiOpenLink: 'Open Google authorization page',
    geminiCopyLink: 'Copy authorization link',
    geminiApproved: 'Login successful',
    geminiExpired: 'Authorization expired. Please try again.',
