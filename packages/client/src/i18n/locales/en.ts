export default {
  ...
  groupChat: {
    ...
    inviteCodeCopyFailed: 'Failed to copy invite code',
    autoGenerate: 'Auto-generate',
    noRooms: 'No rooms yet',
    selectOrCreate: 'Select or create a room to start chatting',
    agents: 'Agents',
    addAgent: 'Add Agent',
    participantQuickSettings: 'Participant settings',
    mentionParticipant: 'Mention participant',
    participantSettingsNextRun: "Changes apply to this participant's next run.",
    participantSettingsSaved: 'Participant settings saved',
    ...
    triggerTokensDesc: 'Room upper limit; each participant may use a lower safe threshold based on its model context window',
    maxHistoryTokens: 'Max History Tokens',
    maxHistoryTokensDesc: 'Upper limit for compressed history; automatically lowered with the participant effective trigger',
    ...
    handoffModeMentions: 'Mentions from Agent output',
    ...
    handoffRunning: 'Handoff running',
    handoffFailed: 'Handoff failed',
    handoffInterrupted: 'Handoff interrupted',
    activityDock: 'Current activity',
    activityStep: 'Step {step}/{total}',
    viewHandoffProgress: 'View progress',
    stopHandoff: 'Stop entire relay',
    stopReply: 'Stop {agent} reply',
