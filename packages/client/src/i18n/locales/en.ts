...
export default {
  ...
  chat: {
    ...
    autoPlaySpeechOptions: 'Auto-play process messages',
    sessionAutoPlay: 'Auto-play for this session (click: follow → on → off)',
    sessionAutoPlayDefault: 'Session: follow global (click to force ON)',
    sessionAutoPlayOn: 'Session: forced ON (click to OFF)',
    sessionAutoPlayOff: 'Session: forced OFF (click to default)',
    autoPlaySpeechOptionsDesc: 'When auto-play voice is on, also read:',
    autoPlaySpeechInterim: 'Interim assistant messages (default)',
    autoPlaySpeechReasoning: 'Reasoning (merged into final read)',
    autoPlaySpeechTools: 'Tool narration',
    voiceInput: {
  ...
  settings: {
    ...
    voice: {
      ...
      openrouterCloneHint: 'Upload 10-30s of clean speech as the cloning reference (mp3/wav, max 10MB). This is stateless cloning: the reference audio is sent with every synthesis request; only fish-audio/s2.1-pro models support it.',
      ...
      speechPreprocessingTitle: 'Speech Preprocessing',
      ttsGlobalTitle: 'Global Speed & Volume',
      ttsGlobalHint: "Affects all TTS output (auto-play / test / draft). aliyun doesn't support these. edge uses the rate slider above.",
      ttsGlobalSpeed: 'Speed',
      ttsGlobalVolume: 'Volume',
      ttsGlobalVolumeHint: 'zhipu/minimax 0~10 / siliconflow/fishaudio mapped to dB',
      ttsPreviewTitle: 'Voice Draft Preview',
      ttsPreviewDescription: 'Turn long text into a pre-processed voice draft, edit it, then listen (skips re-processing so what you hear is exactly the draft). Tune prompts and audition providers here.',
      ttsPreviewInputPlaceholder: 'Paste text (model rewrite triggers on long text / code blocks / tables)…',
      ttsPreviewUseSample: 'Sample',
      ttsPreviewGenerate: 'Generate draft',
      ttsPreviewDraftLabel: 'Voice draft (editable)',
      ttsPreviewListen: 'Listen (active: {provider})',
      ttsPreviewNoProvider: 'Activate a TTS provider in Voice settings first',
      ttsPreviewInputEmpty: 'Enter some text first',
      ttsPreviewGeneratedOk: 'Draft ready — edit or listen',
      ttsPreviewGenerateFailed: 'Failed to generate draft: {error}',
      ttsPreviewListenFailed: 'Failed to play: {error}',
      ttsPreviewSample: 'Intraday: TongFu Microelectronics down -3%, volume up; JCET max drawdown -5.8%. Memory chip prices +12.5% YoY but -3% MoM. NAURA H1 net profit 1.25B CNY, growth -8.3%.',
      ttsFallbackTitle: 'TTS Fallback',
      ttsFallbackDescription: 'If the active voice provider fails, playback automatically tries each backup provider in order, so auto-play never goes silent. Network errors / timeouts / server faults trigger failover; invalid API keys do not (they surface as clear errors instead).',
      ttsFallbackActiveProvider: 'Active (primary):',
      ttsFallbackOrderHint: 'Failover order (tried in sequence when the primary fails):',
      ttsFallbackEmpty: 'No backup providers configured. Speech will be silent if the primary fails.',
      ttsFallbackAddPlaceholder: 'Add a backup provider…',
      ttsFallbackSave: 'Save fallback',
      ttsFallbackReset: 'Disable & clear',
      ttsFallbackLoadFailed: 'Failed to load fallback settings',
      ttsFallbackSaveFailed: 'Failed to save fallback settings',
      speechPreprocessingDescription: 'Clean Markdown into speech-friendly text before synthesis: rule-layer denoising (code blocks/tables/URLs/emoji), with model rewriting for complex content.',
      speechPreprocessingEnabled: 'Enable speech preprocessing',
      speechPreprocessingEnabledHint: 'When off, behavior is identical to today. When on, auto-played AI replies pass through this pipeline first.',
      speechPreprocessingProvider: 'Model provider',
      speechPreprocessingProviderHint: 'Entry name registered in Hermes custom_providers',
      speechPreprocessingModel: 'Cleaning model',
      speechPreprocessingModelHint: 'Model used for rewriting/summarizing',
      speechPreprocessingMode: 'Mode',
      speechPreprocessingModeFaithful: 'Faithful rewrite',
      speechPreprocessingModeFaithfulHint: 'Keep all information; summarize code blocks, narrate tables in natural language',
      speechPreprocessingModeSummary: 'Summary',
      speechPreprocessingModeSummaryHint: 'Read only key conclusions and data (under 200 chars)',
      speechPreprocessingPrompt: 'System prompt',
      speechPreprocessingPromptHint: 'Switching mode loads the matching preset; you can edit it freely',
      speechPreprocessingPromptRestore: 'Restore preset',
      speechPreprocessingTriggers: 'Trigger conditions',
      speechPreprocessingTriggerCode: 'Contains code block',
      speechPreprocessingTriggerTable: 'Contains table',
      speechPreprocessingTriggerChars: 'Longer than',
      speechPreprocessingTriggerCharsHint: 'Model rewriting kicks in above this length (short replies play with zero extra delay)',
      speechPreprocessingSave: 'Save settings',
      speechPreprocessingSaved: 'Speech preprocessing settings saved',
      speechPreprocessingSaveFailed: 'Failed to save: {error}',
      speechPreprocessingLoadFailed: 'Failed to load speech preprocessing settings',
    },
},
