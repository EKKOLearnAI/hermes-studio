export default {
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimationHint: 'Customize the animation shown while AI is thinking',
      taCustomLoaded: 'Custom animation loaded',
      taDefault: 'Using default animation',
      taChange: 'Change',
      taUpload: 'Upload',
      taResetDefault: 'Reset to default',
      taHelp: 'Supports GIF, MP4, WebM formats. MOV/AVI/MKV will be auto-converted to MP4. Max 100MB.',
