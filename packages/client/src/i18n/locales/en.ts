export default {
  ...
  chat: {
    ...
    approvalDeny: 'Deny',
    approvalSubmitting: 'Sending approval…',
    approvalFailed: 'Approval was not accepted. You can retry.',
    approvalExpired: 'Approval expired',
    approvalExpiredHint: 'The command will not run.',
