export default {
  ...
  settings: {
    ...
    models: {
      ...
      apiKeysTab: 'API Keys',
      divisionTab: 'Model Division',
    },
    modelDivision: {
      mainTitle: 'Main Model (Planning)',
      mainRole: 'Guide',
      mainDesc: 'Model used by the main session for planning, guidance and review. Pair it with an inexpensive subagent model.',
      mainHint: 'The main model is the global default model — switch it anytime from the model selector at the top.',
      childTitle: 'Subagent Model (Execution)',
      childRole: 'Worker',
      childDesc: 'Model used by delegate_task subagents for execution. Pick an inexpensive model to cut cost on high-volume work.',
      save: 'Save',
      saved: 'Saved',
      saveFailed: 'Save failed',
      mainModelRequired: 'Please select a main model',
      childModelRequired: 'Please select a subagent model',
      loadFailed: 'Failed to load model division settings',
      reasoningEffort: 'Subagent reasoning effort',
      reasoningInherit: 'Inherit from main session',
      reasoningHint: 'Leave empty to inherit the main session level. For high-volume subagent work, low/medium saves cost.',
    },
    display: {
