export default {
  ...
  "chat": {
    ...
    "folderPickerEmpty": "No folder selected",
    "folderPickerNoFolders": "No folders available",
    "folderPickerSelected": "Selected folder: {folder}",
  ...
  "models": {
    ...
    "auxiliarySubtitle": "Assign specialized models for background tasks.",
    "auxiliaryTask": "Task",
    "auxiliaryDefault": "Default",
    "auxiliaryProviderAuto": "Auto",
    "auxiliaryProviderMain": "Use main model",
    "auxiliaryCustomEndpoint": "Custom endpoint",
    "auxiliaryExtraBody": "Extra request body",
    "auxiliaryInvalidExtraBody": "Extra body must be valid JSON",
    ...
    "auxiliarySaved": "Auxiliary model settings saved",
    "auxiliarySaveFailed": "Failed to save auxiliary model settings",
    "auxiliaryLoadFailed": "Failed to load auxiliary model settings",
  ...
  "settings": {
    ...
    "userAvatar": {
      "title": "User avatar",
      "hint": "Upload or randomize the avatar shown for your account.",
      ...
      "invalidType": "Unsupported image type",
  ...
  "changelog": {
    "new_0_6_8_1": "Aurora desktop and app surfaces continue to improve.",
    "new_0_6_8_2": "Navigation and workspace flows are more reliable.",
    "new_0_6_8_3": "Model and tool configuration received usability fixes.",
    "new_0_6_8_4": "Session history and chat rendering are more stable.",
    "new_0_6_8_5": "Runtime fixes improve Web UI reliability.",
    "new_0_6_9_1": "Aurora app launch and desktop routing were refined.",
    "new_0_6_9_2": "Code intelligence workflows gained additional safeguards.",
    "new_0_6_9_3": "Chat input and draft handling were improved.",
    "new_0_6_9_4": "Sidebar navigation is easier to scan.",
    "new_0_6_9_5": "Internationalization coverage was expanded.",
    "new_0_6_9_6": "General stability fixes landed across the client.",
    "new_0_6_10_1": "Aurora workspace capabilities were expanded.",
    "new_0_6_10_2": "Youzi Quant Lab integration remains available in the agent workspace.",
    "new_0_6_10_3": "Auxiliary model controls support specialized background tasks.",
    "new_0_6_10_4": "User avatar settings now support upload and reset flows.",
    "new_0_6_10_5": "Diff rendering keeps large unified diffs readable.",
    "new_0_6_10_6": "Folder picker states are clearer.",
    "new_0_6_10_7": "Model cache refresh actions report progress and failures.",
    "new_0_6_10_8": "Collapsed sidebar groups use compact labels.",
    "new_0_6_10_9": "Browser tab titles now reflect the active chat.",
    "new_0_6_10_10": "Client test coverage was updated for the latest Aurora features.",
  ...
  "aurora": {
    "brand": {
      "name": "Aurora OS",
      "subtitle": "AI Operating Layer",
      "bottomTitle": "Aurora",
      "bottomSubtitle": "Your AI Operating Layer"
    },
    "nav": {
      "navigation": "Aurora navigation",
      "system": "Aurora System",
      "home": "Home",
      "status": "Aurora System Status",
      "memoryQueue": "Memory Review Queue",
      "history": "History"
    },
    "dock": {
      "label": "Aurora Tools Dock",
      "tools": "Tools",
      "files": "Files",
      "filesDesc": "Workspace files",
      "calendar": "Calendar",
      "calendarDesc": "Jobs and scheduled work",
      "mail": "Mail",
      "mailDesc": "Channels and inbox bridges",
      "memory": "Memory",
      "memoryDesc": "Governed memory",
      "chart": "Chart",
      "chartDesc": "TradingView live market chart",
      "sandbox": "Sandbox",
      "sandboxDesc": "MiroFish simulation sandbox",
      "openTool": "Open {tool}",
      "expandedLabel": "Expanded Aurora App Launcher",
      "expand": "Expand Aurora App Grid",
      "collapse": "Collapse Aurora App Grid",
      "gridTitle": "Aurora App Grid"
    },
    "memoryStream": {
      "aria": "Neural Memory",
      "title": "Neural Memory",
      "subtitle": "Recent Verdicts",
      "refresh": "Refresh Neural Memory",
      "rehydrate": "Rehydrate {topic}",
      "recordsSource": "MiroFish Records",
      "hydrating": "Hydrating...",
      "offline": "Memory offline",
      "empty": "No verdicts yet",
      "emptyHint": "Run MiroFish once and Aurora will pin the latest verdicts here.",
      "fallbackPreview": "Open this memory to rehydrate its debate graph in MiroFish.",
      "recent": "recent"
    },
    "topbar": {
      "quickControls": "Aurora quick controls",
      "appMenu": "Aurora App Menu",
      "appMenuList": "Aurora App Menu List",
      "apps": "Aurora Apps",
      "appsHint": "{profile} desktop · pinned first, recent apps float up.",
      "desktopPresets": "Aurora Desktop Presets",
      "applyPreset": "Apply {preset} desktop preset",
      "openFromTopBar": "Open {app} from Top Bar",
      "pinApp": "Pin {app}",
      "unpinApp": "Unpin {app}",
      "pinned": "Pinned",
      "export": "Export",
      "import": "Import",
      "desktop": "Desktop",
      "returnDesktop": "Return to Aurora Desktop",
      ...
      "usageTokens": "Usage {tokens} tokens",
      "webUiVersion": "Aurora v{version}",
      "userMenu": "User Menu",
      "settings": "Settings",
      ...
      "profileSyncedDetail": "Stored in Hermes profile {profile}.",
      "syncing": "Syncing",
      "syncingDetail": "Aurora is comparing profile preferences and local desktop pins.",
      "localFallback": "Local Fallback",
      "localFallbackDetail": "Profile sync is unavailable, so Aurora is using this browser only.",
      "localReady": "Local Ready",
      "localReadyDetail": "Desktop pins are loaded locally and will sync when profile preferences are available.",
      "lastSync": " Last sync {time}.",
      "exportSuccess": "Exported {profile} desktop.",
      "importInvalid": "No valid pinned apps found.",
      "importSuccess": "Imported {count} pinned apps for {profile}.",
      "importFailed": "Import failed. Use an Aurora desktop JSON export.",
      "presetApplied": "Applied {preset} desktop preset."
    },
    "omnibar": {
      "modeLabel": "OmniBar mode",
      "auroraModeLabel": "Aurora mode",
      "placeholder": "What would you like to build or do today?",
      "ask": "Ask",
      "build": "Build",
      "automate": "Automate",
      "working": "Working",
      ...
      "context": "Context",
      "buildPreview": "10-step sandbox build pipeline",
      "automatePreview": "Route recurring work through Hermes",
      "newIntent": "New intent",
      "attachment": "{count} attachment(s)",
      "historyPalette": "Chat History Palette",
      "historyTitle": "Chat History",
      "noRecentChats": "No recent chats yet",
      "untitledIntent": "Untitled intent",
      "summonPalette": "Agent Summon Palette",
      "summon": "Summon",
      "skillsPalette": "Skills and Plugins Palette",
      "skillsTitle": "Skills & Plugins",
      "loadingSkills": "Loading available skills and plugins...",
      "noMatchingSkills": "No matching skills or plugins",
      "slashLoadError": "Some skills or plugins could not be loaded.",
      "useSkillContext": "Use this skill as intent context",
      "usePluginContext": "Use this plugin as intent context",
      "quantWatching": "Hermes is watching",
      "agent": "Agent",
      "channel": "Channel",
      "commanderDesc": "Route intent through Aurora Commander",
      "quantDesc": "Market snapshot, Top 10, paper trading",
      "lifeosDesc": "FIRE, budget, net worth dashboard",
      "memoryDesc": "Search or propose governed memory",
      "kanbanDesc": "Tasks, boards, execution state",
      "groupDesc": "Summon multi-agent discussion",
      "recent": "recent"
    }
  },
  "codeIntelligence": {
