export default {
  ...
  models: {
    ...
    copilotLoginIntro: 'Hermes Web UI shares GitHub authentication via the local gh CLI. Sign in once and the credentials are reused.',
    copilotStep1: 'Make sure the GitHub CLI (gh) is installed on this machine.',
    copilotStep2: 'Run the following command in a system terminal:',
    copilotStep3: 'After the browser authorization completes, click "Refresh detection" below.',
    copilotLoginNote: 'The authorization is persisted by gh CLI on this machine and remains valid after restarting Web UI.',
    copilotCopied: 'Command copied',
    copilotDetected: 'GitHub Copilot detected and ready to use.',
    copilotNotDetected: 'Copilot authorization not detected yet. Please confirm `gh auth login` succeeded.',
    copilotRefresh: 'Refresh detection',
    customBadge: 'CUSTOM',
