export default {
  ...
  updates: {
    title: 'Updates',
    subtitle: 'Release-first update and preview surface',
    refresh: 'Refresh',
    updating: 'Updating...',
    currentStableTitle: 'Current stable',
    installedVersion: 'Installed version',
    updateStatus: 'Update status',
    connected: 'Connected',
    disconnected: 'Disconnected',
    sourceUnavailableTitle: 'Release source unavailable',
    sourceUnavailableBody: 'This installation is not reporting live release status.',
    latestReleaseTitle: 'Latest upstream release',
    latestReleaseVersion: 'Latest version',
    latestReleaseBody: 'Review the newest release reported by the server before switching stable.',
    latestReleaseAvailable: 'Available',
    unavailable: 'Unavailable',
    latestReleaseUnavailable: 'Latest upstream release is not available on this installation.',
    previewTitle: 'Preview',
    previewBody: 'Preview the next release before you switch stable.',
    previewStableCopy: 'Stable stays unchanged unless you click Preview -> Stable.',
    previewUnavailableTitle: 'Preview unavailable',
    previewSuperAdminRequired: 'Super administrator access is required for preview management.',
    previewDisabled: 'Dev Mode is disabled on this installation.',
    previewUnavailable: 'Preview is not configured on this installation.',
    openDevMode: 'Open Dev Mode',
    previewBranch: 'Preview branch',
    previewBaseBranch: 'Review base',
    previewStartedAt: 'Started at',
    recoveryTitle: 'Recovery',
    recoveryBody: 'Use recovery actions when release status looks stale or the source is unavailable.',
    recoveryHintTitle: 'Recovery tips',
    recoveryHintBody: 'Refresh status first. If the client bundle is stale, reload the page; if an update is available, start it from here.',
    reloadClient: 'Reload client',
    updateNow: 'Update now',
    updateStableTo: 'Update stable to v{version}',
  ...
  settings: {
    ...
    dev: {
      ...
      developerToolsHint: 'Hidden maintainer-only tools for local review and diagnostics.',
      enabled: 'Branch preview',
      enabledHint: 'Allow admin users to manage branch preview builds',
      warningTitle: 'Security warning',
      warningBody: 'Branch preview builds code from selected branches inside an isolated worktree. Keep it disabled unless you trust the repository and understand the risk.',
      branchPreviewTitle: 'Branch preview',
      branchToPreview: 'Branch to preview',
      ...
      baseBranchHint: 'Reset returns preview to this branch.',
      baseBranchPlaceholder: 'Select base branch',
      refreshBranches: 'Refresh branches',
      refreshStatus: 'Refresh status',
      branchRequired: 'Please select a branch first',
      ...
      loadFailed: 'Failed to load branch preview status',
      buildStarted: 'Branch build started',
      buildFailed: 'Branch build failed',
      resetDone: 'Preview target reset',
      resetFailed: 'Failed to reset preview target',
      removePreview: 'Remove preview',
      removePreviewConfirm: 'Remove the current preview and clear the active worktree?',
      removePreviewDone: 'Preview removed',
      removePreviewFailed: 'Failed to remove preview target',
      promotePreview: 'Make preview current',
      promotePreviewConfirm: 'Promote the current preview branch to become the new review base?',
      promotePreviewDone: 'Preview branch promoted',
      promotePreviewFailed: 'Failed to promote preview target',
      restoreLatestRelease: 'Restore latest upstream release',
      restoreLatestReleaseConfirm: 'Restore the latest upstream release and clear the current preview?',
      restoreLatestReleaseDone: 'Latest upstream release restored',
      restoreLatestReleaseFailed: 'Failed to restore latest upstream release',
      disabledNote: 'Branch preview is currently disabled. Choose branches, enable it, then save settings before building or resetting.',
      notConfiguredTitle: 'Branch preview is not configured',
      capabilityUnavailable: 'Branch preview is unavailable on this instance.',
      capabilityReasons: {
        disabled: 'Branch preview is disabled on this instance.',
        repo_path_missing: 'Branch preview needs a local git checkout before it can be used.',
        not_git_repo: 'Branch preview needs the Web UI to run from a local git checkout.',
      },
      permissionTitle: 'Super administrator required',
      permissionBody: 'Branch preview can only be changed by a super administrator.',
    },
    apiServer: {
      enable: 'Enable',
