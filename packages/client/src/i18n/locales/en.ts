export default {
  ...
  chat: {
    ...
    approvalModeTooltip: 'Approval mode for this session — how dangerous commands are approved',
    approvalModeManual: 'Manual',
    approvalModeSmart: 'Smart',
    approvalModeOff: 'Full access',
    approvalModeOffConfirmTitle: 'Enable full authorization?',
    approvalModeOffConfirmContent: 'This session will skip ALL approval prompts — every command is auto-approved, including dangerous ones. Deny rules still apply. Continue?',
    approvalModeOffConfirmOk: 'Enable',
    approvalModeOffConfirmCancel: 'Cancel',
    slashCommandArgs: {
      message: '<message>',
      title: '<title>',
      text: '<text>',
    ...
    slashCommands: {
      ...
      approvalModeManual: 'Approve manually',
      approvalModeSmart: 'AI auto-approves safe commands',
      approvalModeOff: 'Full authorization (skip all approvals)',
