export default {
  ...
  petdex: {
    ...
    local: {
      ...
      emptyLocal: 'No local pets yet. Import your first pet to get started.',
      loadFailed: 'Failed to load local pets',
      imported: 'Imported {name}',
      importFailed: 'Failed to import pet',
      spritesheetRequired: 'Select a spritesheet file',
      displayName: 'Name',
      displayNamePlaceholder: 'Pet name',
      kind: 'Kind',
      submittedBy: 'Author',
      ...
      autoFilled: 'Filled metadata from {source}',
      petJsonInvalid: 'pet.json is not valid JSON',
      remove: 'Remove',
      removeTitle: 'Remove Local Pet',
      removeConfirm: 'Remove "{name}"? Its local assets will be deleted and cannot be restored.',
      removed: 'Removed {name}',
      removeFailed: 'Failed to remove pet',
      dropTitle: 'Upload Pet Package',
      dropHint: 'Choose a folder containing pet.json and a spritesheet image.',
      pickFolder: 'Choose Folder',
      pickZip: 'Choose ZIP',
      pickSpritesheet: 'Choose Spritesheet',
      dropNote: 'The package stays local until you confirm the import.',
      reviewTitle: 'Review Import',
      reviewEmpty: 'Choose a spritesheet or folder to review the import.',
      reviewReady: 'Ready to import.',
      spriteLoaded: 'Selected spritesheet: {name}',
      folderMissingSprite: 'The selected folder does not contain spritesheet.*.',
    },
  },
  ...
  settings: {
    ...
    voice: {
      ...
      doubaoCloneVoiceHint: 'Enter voice clone entries as voice ID,voice name; multiple voices are supported.',
      doubaoCloneVoicePlaceholder: 'Example: S_xxxxx,My voice',
      doubaoCloneVoiceFormatError: 'Enter a voice clone entry in the format voice ID,voice name.',
      apiKey: 'API key',
