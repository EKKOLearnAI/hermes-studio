export default {
  ...
  sidebar: {
    ...
    connected: '接続済み',
    disconnected: '未接続',
    updateTip: 'カスタム版の更新は社内リリース手順で管理されます',
    ...
    updateFailed: '更新に失敗しました。内部更新ソース設定を確認してください。',
    updateSource: '更新元: {source}',
    updateManagedInternally: 'カスタム版: 更新は内部リリース手順で管理されます',
    logout: 'ログアウト',
  ...
  chat: {
    ...
    emptyState: 'Quanthermes Agent と会話を開始しましょう',
  ...
  changelog: {
    ...
    new_0_6_0_7: 'ログイン IP ロックのクリアと既定の quanthermes / 12345678 ログインをリセットする CLI メンテナンスコマンドを追加',
