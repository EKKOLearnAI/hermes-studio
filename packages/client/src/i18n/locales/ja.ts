export default {
  ...
  chat: {
    ...
    addAgent: 'Agent を追加',
    participantQuickSettings: '参加者設定',
    mentionParticipant: '参加者をメンション',
    participantSettingsNextRun: '変更はこの参加者の次回実行から適用されます。',
    participantSettingsSaved: '参加者設定を保存しました',
    participantRuntime: 'ランタイム',
    participantMode: 'モード',
  ...
  groupChat: {
    ...
    activityDock: '現在のアクティビティ',
    activityStep: 'ステップ {step}/{total}',
    viewHandoffProgress: '進行状況を表示',
    stopHandoff: 'リレー全体を停止',
    stopReply: '{agent} の返信を停止',
