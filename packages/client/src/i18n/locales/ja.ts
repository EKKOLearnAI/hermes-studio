export default {
  ...
  settings: {
    ...
    voice: {
      ...
      clearStoredKey: '保存済みキーをクリア',
      storedServerKey: 'サーバー保存済みキー: {value}',
      secretPendingSave: '保存時に更新されます',
      storedOnServer: 'サーバーに保存済み',
      saveTtsSettings: 'TTS 設定を保存',
      webspeechSettingsSaved: 'WebSpeech 設定をローカルに保存しました。',
      ttsSettingsSaved: 'TTS 設定をサーバーに保存しました。',
      ttsSettingsSaveFailed: 'TTS 設定の保存に失敗しました。',
      storedSecretCleared: 'サーバー保存済み TTS シークレットをクリアしました。',
      storedSecretClearFailed: '保存済み TTS シークレットのクリアに失敗しました。',
      mimoCloneAudioInvalid: 'MiMo クローン音声は mp3 または wav ファイルである必要があります。',
      mimoCloneAudioTooLarge: 'MiMo クローン音声は 10 MB 以下にしてください。',
      mimoCloneAudioReadFailed: '音声ファイルの読み込みに失敗しました。',
      mimoCloneAudioCleared: 'サーバー保存済み MiMo クローン音声をクリアしました。',
      mimoCloneAudioClearFailed: '保存済み MiMo クローン音声のクリアに失敗しました。',
