export default {
  ...
  chat: {
    ...
    dragToPosition: 'ドラッグで位置調整 · スクロールまたはスライダーでズーム',
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimationHint: 'AI 処理中に表示されるアニメーションをカスタマイズ',
      taHelp: '対応フォーマット：GIF、MP4、MOV。最大100 MB。',
      taCustomLoaded: 'カスタムアニメーション読み込み済み',
      taDefault: 'デフォルトアニメーションを使用中',
      taChange: '変更',
      taUpload: 'アニメーションをアップロード',
      taResetDefault: 'デフォルトに戻す',
      taFileTooLarge: 'ファイルが大きすぎます（最大100 MB）',
      taUploadFailed: 'アップロード失敗',
      taResetFailed: 'リセット失敗',
      theme: 'テーマ',
  ...
  changelog: {
    ...
    new_0_4_3_1: 'BFFプロキシルーティングによるクロスマシンプロファイルサポートを追加',
    new_0_4_3_2: 'キーワードマッチングによるセッション検索を追加',
    new_0_4_3_3: 'コンテキスト使用量トラッキングとトークン表示を追加',
    new_0_4_3_4: 'プロバイダー別コンテキスト長ルックアップを追加',
    new_0_4_1_1: 'Hermes Web UI 初版リリース。チャット、モデル、セッション管理をサポート',
  },
  ...
  // Gateway Tabs
  gatewayTabs: {
    cannotDeleteActive: 'アクティブなプロフィールは削除できません',
    created: 'プロフィール "{name}" を作成しました',
    createFailed: 'プロフィールの作成に失敗しました',
    createTitle: 'プロフィール作成',
    delete: '削除',
    deleted: 'プロフィール "{name}" を削除しました',
    deleteFailed: 'プロフィールの削除に失敗しました',
    export: 'エクスポート',
    exported: 'プロフィール "{name}" をエクスポートしました',
    exportFailed: 'プロフィールのエクスポートに失敗しました',
    namePlaceholder: 'プロフィール名を入力',
    nameRequired: 'プロフィール名は必須です',
    newProfile: '新しいプロフィール',
    noProfiles: 'プロフィールなし',
    rename: '名前を変更',
    renamed: 'プロフィール "{from}" を "{to}" に名前を変更しました',
    renameFailed: 'プロフィールの名前変更に失敗しました',
    renameTitle: 'プロフィール名を変更',
  },
}