...
export default {
  dshPlugins: {
    ...
    "noEntries": "プラグイン項目なし",
    "conditional": "条件付き",
    "additionalPackages": "追加 ACP パッケージ",
    "title": "プラグイン",
    "packages": "パッケージ",
    "install": "インストール",
    "update": "更新",
    ...
    "succeeded": "成功",
    "failed": "失敗",
    "description": "Studio 管理のネイティブ ACP プラグインは各チャットの次回 DSH 起動に適用されます。実行中は元のバージョンを保持します。ブラウザー統合は未対応です。",
    "installHint": "package{'@'}固定バージョンを指定します。インストールスクリプトは実行されません。新しいバンドルは手動で有効化してください。信頼できるパッケージのみを使用してください。",
    "removeConfirm": "次回起動から {name} を削除しますか？",
    "runtimeUnknown": "設定状態のみ表示しています。稼働状態と互換性は未検証です。",
    "entries": "宣言されたプラグイン",
    "discard": "下書きを破棄して最新の設定を読み込みますか？",
    "configHint": "有効なバンドルの後に適用する YAML パッチです。次回 DSH 起動時に反映されます。",
    "rollbackConfirm": "次回起動からこの保存バージョンを使用しますか？",
    "conflict": "設定が変更されました。下書きは保持されています。最新版と比較して再読み込みしてください。",
    "missingDependency": "先に DSH と pnpm をインストールしてください。",
    "busy": "別の操作が実行中、またはパッケージ状態が競合しています。再読み込みして再試行してください。",
    "interrupted": "操作が中断されました。以前のバージョンを保持します。",
    "unsupported": "このパッケージまたは機能はネイティブ ACP 管理で未対応です。",
    "invalid": "固定バージョンまたは YAML パッチ配列を確認してください。",
    "timeout": "操作がタイムアウトしました。以前のバージョンを保持します。"
},
