export default {
  ...
  login: {
    ...
    feishuUatTitle: 'Feishu ツールを認可',
    feishuUatDescription: 'Hermes があなたとして Feishu API を使えるように、Feishu 認可を完了してください。',
    feishuUatOpen: 'Feishu 認可を開く',
    feishuUatFailed: 'Feishu 認可に失敗しました',
  },
  ...
  sidebar: {
    ...
    connected: '接続済み',
    disconnected: '未接続',
    feishuConnected: 'Feishu 接続済み',
    feishuNotConnected: 'Feishu 未接続',
    feishuChecking: 'Feishu 接続を確認中',
    feishuConnecting: 'Feishu に接続中',
    feishuConnectFailed: 'Feishu 接続に失敗しました',
  ...
  chat: {
    ...
    loadSessionsFailed: 'セッションの読み込みに失敗しました',
    retrySessions: '再試行',
    exitBatchMode: '一括モードを終了',
    tooManySessionsInGroup: '{total}件中 {shown}件を表示 — 古い会話は検索を使用してください',
    historyEmptyTitle: 'このプロファイルには履歴がありません',
    historyEmptyHint: 'このログインに紐づく Hermes プロファイルのセッションは、CLI、Feishu、その他のチャネルで記録が作成されるとここに表示されます。',
    newChat: '新しいチャット',
