export default {
  ...
  profiles: {
    ...
    thinkingAnimation: {
      title: '思考アニメーションのカスタマイズ',
      customize: 'アニメーション',
      upload: 'ファイルをアップロード',
      save: '保存',
      reset: 'デフォルトを使用',
      hint: 'GIF、WebP、MP4、WebM。最大5MB。',
      invalidType: 'GIF、WebP、MP4、WebM、または画像ファイルを選択してください',
      tooLarge: 'アニメーションファイルは5MB以下にしてください',
      saveSuccess: '思考アニメーションを保存しました',
      saveFailed: '思考アニメーションの保存に失敗しました',
      resetSuccess: 'デフォルトの思考アニメーションを復元しました',
      resetFailed: 'デフォルトの復元に失敗しました',
      urlPlaceholder: '画像/動画URLを貼り付け、空欄の場合はデフォルト',
      noPreview: 'カスタムアニメーション未設定',
      enableThinking: '思考アニメーションを有効化',
      delete: 'アニメーションを削除',
      maxReached: '最大 {max} 個に達しました',
      savedItems: '{count} 個のアニメーションを保存済み',
    },
    runtime: {
