export default {
  ...
  chat: {
    ...
    clickToSelectImage: 'Haga clic para seleccionar una imagen',
    imageTooLarge: 'La imagen debe ser menor a 5 MB',
    dragToPosition: 'Arrastra para posicionar · Desplaza o usa el control para zoom',
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimation: 'Animacion de pensamiento',
      thinkingAnimationHint: 'Personalizar la animacion que se muestra mientras la IA procesa',
      taHelp: 'Formatos admitidos: GIF, MP4, MOV. Max. 100 MB.',
      taCustomLoaded: 'Animacion personalizada cargada',
      taDefault: 'Usando animacion predeterminada',
      taChange: 'Cambiar',
      taUpload: 'Subir animacion',
      taResetDefault: 'Restablecer predeterminada',
      taFileTooLarge: 'Archivo demasiado grande (max. 100 MB)',
      taUploadFailed: 'Error al subir',
      taResetFailed: 'Error al restablecer',
      theme: 'Tema',
  ...
  changelog: {
    ...
    new_0_4_3_1: 'Soporte de perfiles multi-máquina con enrutamiento proxy BFF',
    new_0_4_3_2: 'Búsqueda de sesiones por palabras clave',
    new_0_4_3_3: 'Seguimiento de uso de contexto y visualización de tokens',
    new_0_4_3_4: 'Búsqueda de longitud de contexto por proveedor',
    new_0_4_1_1: 'Versión inicial de Hermes Web UI con chat, modelos y sesiones',
  },
  ...
  gatewayTabs: {
    ...
    createFailed: 'Error al crear perfil',
    createTitle: 'Crear perfil',
    delete: 'Eliminar',
    deleted: 'Perfil "{name}" eliminado',
    deleteFailed: 'Error al eliminar perfil',
    export: 'Exportar',
    exported: 'Perfil "{name}" exportado',
    exportFailed: 'Error al exportar perfil',
    namePlaceholder: 'Ingrese nombre del perfil',
    nameRequired: 'El nombre del perfil es obligatorio',
    newProfile: 'Nuevo perfil',
    noProfiles: 'Sin perfiles',
    rename: 'Renombrar',
    renamed: 'Perfil "{from}" renombrado a "{to}"',
    renameFailed: 'Error al renombrar perfil',
