export default {
  ...
  chat: {
    ...
    suggestTitleFailed: 'No se pudo sugerir el título',
    suggestTitleReady: 'Sugerencia de título insertada',
    suggestTitleUnchanged: 'El título sugerido ya es el actual',
