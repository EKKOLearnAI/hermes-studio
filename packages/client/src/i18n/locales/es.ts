...
jobTriggered: 'Job ejecutado',
  ...
  settings: {
    ...
    voice: {
      ...
      clearStoredKey: 'Borrar clave guardada',
      storedServerKey: 'Clave guardada en servidor: {value}',
      secretPendingSave: 'se actualizara al guardar',
      storedOnServer: 'Guardado en el servidor',
      saveTtsSettings: 'Guardar ajustes TTS',
      webspeechSettingsSaved: 'Ajustes de WebSpeech guardados localmente.',
      ttsSettingsSaved: 'Ajustes TTS guardados en el servidor.',
      ttsSettingsSaveFailed: 'No se pudieron guardar los ajustes TTS.',
      storedSecretCleared: 'Se borro el secreto TTS guardado en el servidor.',
      storedSecretClearFailed: 'No se pudo borrar el secreto TTS guardado.',
      mimoCloneAudioInvalid: 'El audio de clonacion MiMo debe ser mp3 o wav.',
      mimoCloneAudioTooLarge: 'El audio de clonacion MiMo debe ser de 10 MB o menos.',
      mimoCloneAudioReadFailed: 'No se pudo leer el archivo de audio.',
      mimoCloneAudioCleared: 'Audio de clonacion MiMo borrado del servidor.',
      mimoCloneAudioClearFailed: 'No se pudo borrar el audio de clonacion MiMo guardado.',
