export default {
  ...
  chat: {
    ...
    unarchived: 'Sesión desarchivada',
...
jobTriggered: 'Job ejecutado',
  ...
  settings: {
    ...
    agent: {
      ...
      reasoningEffort: 'Profundidad de razonamiento',
      reasoningEffortHint: 'Controlar la profundidad de pensamiento del modelo (low/medium/high/xhigh)',
      default: 'Por defecto',
      auto: 'Automatico',
      always: 'Siempre',
      never: 'Nunca',
  ...
  download: {
    ...
    showInFolderFailed: 'No se pudo abrir la carpeta',
  },
  gateways: {
