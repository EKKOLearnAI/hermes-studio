export default {
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimationHint: 'Personalizar la animación mostrada mientras la IA piensa',
      taCustomLoaded: 'Animación personalizada cargada',
      taDefault: 'Usando animación por defecto',
      taChange: 'Cambiar',
      taUpload: 'Subir',
      taResetDefault: 'Restablecer por defecto',
      taHelp: 'Soporta GIF, MP4, WebM. MOV/AVI/MKV se convierten automáticamente a MP4. Máx. 100MB.',
      taFileTooLarge: 'Archivo demasiado grande (máx. 100MB)',
