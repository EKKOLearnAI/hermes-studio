export default {
  ...
  sidebar: {
    ...
    updateTip: 'Ejecuta "audbuild update" en la terminal para actualizar',
  ...
  chat: {
    ...
    emptyState: 'Inicia una conversacion con audbuild',
    ...
    hermesHistory: 'Historial de audbuild',
    historyScopeHint: 'Sesiones del historial de audbuild, de solo lectura y agrupadas por origen.',
...
jobTriggered: 'Job ejecutado',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualizar',
    notice: 'Inventario de solo lectura de manifests de plugins audbuild detectables. Los metadatos de descubrimiento se leen sin cargar código de plugins. En v1, la gestión permanece en CLI; los cambios se aplican en nuevas sesiones audbuild.',
  ...
  models: {
    ...
    copilotAddDetected: 'Se detectó un token OAuth de GitHub Copilot en este equipo. Haz clic en Agregar para habilitar Copilot en audbuild.',
    ...
    copilotDeleteHintGhCli: 'Copilot se ocultará de audbuild. Tu sesión de gh CLI no se verá afectada — `gh auth status` seguirá mostrando que estás conectado.',
    copilotDeleteHintAppsJson: 'Copilot se ocultará de audbuild. La extensión Copilot de VS Code seguirá conectada.',
  ...
  skillsUsage: {
    ...
    subtitle: 'Sigue las cargas y ediciones de habilidades en sesiones de audbuild',
    refresh: 'Actualizar',
  ...
  changelog: {
    ...
    new_0_5_15_11: 'Si la función Kanban no está disponible, actualice audbuild',
    ...
    new_0_5_17_9: 'Agregar página de plugins audbuild de solo lectura',
    ...
    new_0_5_5_2: 'Añadida página de historial para sesiones audbuild',
