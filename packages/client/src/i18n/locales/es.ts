...
jobTriggered: 'Job ejecutado',
  ...
  githubPreview: {
    ...
    stop: "Detener",
    note: "El código de vista previa se guarda bajo el directorio de datos de Web UI. Producción sigue en el puerto 8748; la vista previa usa frontend 8651 y backend 8650.",
