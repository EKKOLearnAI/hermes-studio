﻿﻿﻿export default {
  ...
  sidebar: {
    ...
    connected: 'Conectado',
    disconnected: 'Desconectado',
    updateTip: 'Las actualizaciones del build personalizado se gestionan internamente',
    ...
    updateFailed: 'Error al actualizar. Revisa la configuracion de la fuente interna.',
    updateSource: 'Origen de actualizacion: {source}',
    updateManagedInternally: 'Build personalizado: las actualizaciones se gestionan internamente',
  ...
  chat: {
    ...
    emptyState: 'Inicia una conversacion con Quanthermes Agent',
    ...
    hermesHistory: 'Historial de QuantHermes',
    historyScopeHint: 'Sesiones del historial de QuantHermes, de solo lectura y agrupadas por origen.',
...
jobTriggered: 'Job ejecutado',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualizar',
    notice: 'Inventario de solo lectura de manifests de plugins QuantHermes detectables. Los metadatos de descubrimiento se leen sin cargar código de plugins. En v1, la gestión permanece en CLI; los cambios se aplican en nuevas sesiones QuantHermes.',
  ...
  models: {
    ...
    copilotAddDetected: 'Se detectó un token OAuth de GitHub Copilot en este equipo. Haz clic en Agregar para habilitar Copilot en QuantHermes.',
    ...
    copilotDeleteHintGhCli: 'Copilot se ocultará de QuantHermes. Tu sesión de gh CLI no se verá afectada — `gh auth status` seguirá mostrando que estás conectado.',
    copilotDeleteHintAppsJson: 'Copilot se ocultará de QuantHermes. La extensión Copilot de VS Code seguirá conectada.',
  ...
  skillsUsage: {
    ...
    subtitle: 'Sigue las cargas y ediciones de habilidades en sesiones de QuantHermes',
    refresh: 'Actualizar',
  ...
  changelog: {
    ...
    new_0_6_0_7: 'Añade comandos CLI de mantenimiento para limpiar bloqueos de IP de login y restablecer el login predeterminado quanthermes / 12345678',
