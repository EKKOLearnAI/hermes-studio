export default {
  ...
  models: {
    ...
    copilotLoginIntro: 'Hermes Web UI comparte la autenticación de GitHub a través del CLI gh local. Inicie sesión una vez y se reutilizarán las credenciales.',
    copilotStep1: 'Asegúrese de que GitHub CLI (gh) esté instalado en esta máquina.',
    copilotStep2: 'Ejecute el siguiente comando en un terminal del sistema:',
    copilotStep3: 'Después de completar la autorización en el navegador, haga clic en "Actualizar detección" abajo.',
    copilotLoginNote: 'La autorización es persistida por gh CLI en esta máquina y permanece válida tras reiniciar Web UI.',
    copilotCopied: 'Comando copiado',
    copilotDetected: 'GitHub Copilot detectado y listo para usar.',
    copilotNotDetected: 'Autorización de Copilot aún no detectada. Confirme que `gh auth login` se completó.',
    copilotRefresh: 'Actualizar detección',
