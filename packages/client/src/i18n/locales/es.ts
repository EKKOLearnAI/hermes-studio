...
jobTriggered: 'Job ejecutado',
  ...
  models: {
    ...
    noModels: 'No hay modelos disponibles. Asegúrese de que al menos un proveedor tenga una clave API configurada, o añada un proveedor personalizado en Configuración → Modelos.',
    noResults: 'No se encontraron modelos coincidentes.',
