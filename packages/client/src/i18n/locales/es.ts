export default {
  ...
  runtimeVersions: {
    ...
    runtimeDirectoryHint: 'El Runtime actual se copiará y verificará antes de iniciar los servicios locales en el próximo reinicio. La copia anterior se conservará.',
    ...
    runtimeMigrationFailed: 'La migración de Runtime falló; se sigue usando el Runtime anterior',
    active: 'Activa',
    installed: 'Instalada',
    download: 'Descargar',
...
jobTriggered: 'Job ejecutado',
  ...
  changelog: {
    ...
    new_0_6_31_12: 'La gestión de versiones ahora permite reubicar el almacenamiento de Runtime; la migración se ejecuta antes de los servicios en el siguiente reinicio y conserva la copia anterior (#2134)',
