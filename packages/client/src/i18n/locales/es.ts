...
jobTriggered: 'Job ejecutado',
  ...
  workflow: {
    ...
    edgeEditor: {
      ...
      conditionPathOptions: { routeOnly: 'Solo ruta — sin condición', outputRecommended: 'Texto de respuesta correcta (output, recomendado)', output: 'Texto de respuesta correcta (output)', outputJson: 'JSON de respuesta estructurado (outputJson.*)', errorRecommended: 'Texto del error (error, recomendado)', error: 'Texto del error (error)', custom: 'Ruta personalizada (avanzado)' },
