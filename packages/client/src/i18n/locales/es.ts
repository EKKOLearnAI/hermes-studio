export default {
  ...
  login: {
    ...
    tokenLogin: 'Token',
    feishuLogin: 'Iniciar sesion con Feishu',
  ...
  sidebar: {
    ...
    feishuNotConnected: 'Feishu no conectado',
    feishuChecking: 'Comprobando conexion de Feishu',
    feishuConnecting: 'Conectando Feishu',
    feishuConnectFailed: 'Error de conexion de Feishu',
  ...
  chat: {
    ...
    loadSessionsFailed: 'No se pudieron cargar las sesiones',
    retrySessions: 'Reintentar',
    exitBatchMode: 'Salir del modo por lotes',
    tooManySessionsInGroup: 'Mostrando {shown} de {total} — usa la búsqueda para conversaciones antiguas',
    historyEmptyTitle: 'Sin historial para este perfil',
    historyEmptyHint: 'Las sesiones del perfil de Hermes vinculado a este inicio de sesión aparecerán aquí cuando CLI, Feishu u otros canales creen registros.',
    newChat: 'Nuevo chat',
