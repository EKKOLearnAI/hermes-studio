...
jobTriggered: 'Job ejecutado',
  ...
  profiles: {
    ...
    thinkingAnimation: {
      title: 'Animación de pensamiento personalizada',
      customize: 'Animación',
      upload: 'Subir archivo',
      save: 'Guardar',
      reset: 'Usar predeterminado',
      hint: 'GIF, WebP, MP4 o WebM. Máx. 5 MB.',
      invalidType: 'Elige un archivo GIF, WebP, MP4, WebM o imagen',
      tooLarge: 'El archivo debe ser de 5 MB o menos',
      saveSuccess: 'Animación de pensamiento guardada',
      saveFailed: 'Error al guardar la animación',
      resetSuccess: 'Animación predeterminada restaurada',
      resetFailed: 'Error al restaurar',
      urlPlaceholder: 'Pega la URL o déjalo vacío para el predeterminado',
      noPreview: 'Sin animación personalizada',
      enableThinking: 'Habilitar animación de pensamiento',
      delete: 'Eliminar animación',
      maxReached: 'Se alcanzó el máximo de {max} animaciones',
      savedItems: '{count} animación(es) guardada(s)',
    },
    runtime: {
