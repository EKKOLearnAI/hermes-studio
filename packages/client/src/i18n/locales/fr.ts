export default {
  ...
  chat: {
    ...
    suggestTitle: 'Suggérer un titre',
    suggestTitleFailed: 'Échec de la suggestion de titre',
    suggestTitleReady: 'Suggestion de titre insérée',
    suggestTitleUnchanged: 'Le titre suggéré est déjà actuel',
