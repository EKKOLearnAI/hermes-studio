export default {
  ...
  chat: {
    ...
    unarchived: 'Session désarchivée',
...
jobTriggered: 'Job declenche',
  ...
  settings: {
    ...
    agent: {
      ...
      reasoningEffortHint: 'Contrôler la profondeur de réflexion du modèle (low/medium/high/xhigh)',
      default: 'Par défaut',
      auto: 'Automatique',
      always: 'Toujours',
      never: 'Jamais',
  ...
  download: {
    ...
    showInFolderFailed: 'Impossible d\'ouvrir le dossier',
  },
  gateways: {
    title: 'Passerelles',
    running: 'En cours',
