...
jobTriggered: 'Job declenche',
  ...
  models: {
    ...
    noModels: 'Aucun modèle disponible. Assurez-vous qu au moins un fournisseur a une clé API configurée, ou ajoutez un fournisseur personnalisé dans Paramètres → Modèles.',
    noResults: 'Aucun modèle correspondant trouvé.',
