...
jobTriggered: 'Job declenche',
  ...
  githubPreview: {
    ...
    stop: "Arrêter",
    note: "Le code de prévisualisation est stocké dans le dossier de données Web UI. La production reste sur le port 8748 ; la prévisualisation utilise le frontend 8651 et le backend 8650.",
