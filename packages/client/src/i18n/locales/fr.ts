﻿﻿﻿﻿﻿﻿﻿export default {
  ...
  sidebar: {
    ...
    connected: 'Connecte',
    disconnected: 'Deconnecte',
    updateTip: 'Les mises a jour des builds personnalises sont gerees en interne',
    ...
    updateFailed: 'Echec de la mise a jour. Verifiez la source interne.',
    updateSource: 'Source de mise a jour : {source}',
    updateManagedInternally: 'Build personnalise : les mises a jour sont gerees en interne',
    logout: 'Deconnexion',
  ...
  chat: {
    ...
    emptyState: 'Demarrer une conversation avec Quanthermes Agent',
    ...
    hermesHistory: 'Historique QuantHermes',
    historyScopeHint: 'Sessions d’historique QuantHermes en lecture seule, regroupées par source.',
...
jobTriggered: 'Job declenche',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualiser',
    notice: 'Inventaire en lecture seule des manifests de plugins QuantHermes détectables. Les métadonnées de découverte sont lues sans charger le code des plugins. En v1, la gestion reste dans le CLI; les changements prennent effet dans les nouvelles sessions QuantHermes.',
  ...
  models: {
    ...
    copilotAddDetected: 'Un token OAuth GitHub Copilot a été détecté sur cette machine. Cliquez sur Ajouter pour activer Copilot dans QuantHermes.',
    ...
    copilotDeleteHintAppsJson: 'Copilot sera masqué dans QuantHermes. Votre extension Copilot de VS Code reste connectée.',
  ...
  skillsUsage: {
    ...
    subtitle: 'Suivre les chargements et modifications de compétences dans les sessions QuantHermes',
    refresh: 'Actualiser',
  ...
  changelog: {
    ...
    new_0_6_0_7: 'Ajoute des commandes CLI de maintenance pour effacer les verrous IP de connexion et réinitialiser le login par défaut quanthermes / 12345678',
