export default {
  ...
  models: {
    ...
    copilotLoginIntro: 'Hermes Web UI partage l\'authentification GitHub via la CLI gh locale. Connectez-vous une fois et les identifiants seront réutilisés.',
    copilotStep1: 'Vérifiez que GitHub CLI (gh) est installé sur cette machine.',
    copilotStep2: 'Exécutez la commande suivante dans un terminal système :',
    copilotStep3: 'Après l\'autorisation dans le navigateur, cliquez sur « Actualiser la détection » ci-dessous.',
    copilotLoginNote: 'L\'autorisation est persistée par gh CLI sur cette machine et reste valide après le redémarrage de Web UI.',
    copilotCopied: 'Commande copiée',
    copilotDetected: 'GitHub Copilot détecté et prêt à l\'emploi.',
    copilotNotDetected: 'Autorisation Copilot non détectée. Veuillez confirmer que `gh auth login` a réussi.',
    copilotRefresh: 'Actualiser la détection',
