export default {
  ...
  chat: {
    ...
    cropAvatar: 'Rogner l avatar',
    clickToSelectImage: 'Cliquez pour sélectionner une image',
    imageTooLarge: 'L image doit faire moins de 5 Mo',
    dragToPosition: 'Glissez pour positionner · Défilez ou utilisez le curseur pour zoomer',
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimation: 'Animation de reflexion',
      thinkingAnimationHint: 'Personnaliser l\'animation affichee pendant le traitement de l\'IA',
      taHelp: 'Formats pris en charge : GIF, MP4, MOV. Max. 100 Mo.',
      taCustomLoaded: 'Animation personnalisee chargee',
      taDefault: 'Animation par defaut',
      taChange: 'Changer',
      taUpload: 'Telecharger l\'animation',
      taResetDefault: 'Reinitialiser par defaut',
      taFileTooLarge: 'Fichier trop volumineux (max. 100 Mo)',
      taUploadFailed: 'Echec du telechargement',
      taResetFailed: 'Echec de la reinitialisation',
      theme: 'Theme',
  ...
  changelog: {
    ...
    new_0_4_3_1: 'Support des profils multi-machine avec routage proxy BFF',
    new_0_4_3_2: 'Recherche de sessions par mots-clés',
    new_0_4_3_3: 'Suivi de l\'utilisation du contexte et affichage des tokens',
    new_0_4_3_4: 'Recherche de longueur de contexte par fournisseur',
    new_0_4_1_1: 'Version initiale de Hermes Web UI avec chat, modèles et sessions',
  },
  ...
  // Gateway Tabs
  gatewayTabs: {
    cannotDeleteActive: 'Impossible de supprimer le profil actif',
    ...
    export: 'Exporter',
    exported: 'Profil "{name}" exporté',
    exportFailed: 'Échec de l\'export du profil',
    namePlaceholder: 'Entrez le nom du profil',
    nameRequired: 'Le nom du profil est requis',
    newProfile: 'Nouveau profil',
    noProfiles: 'Aucun profil',
    rename: 'Renommer',
    renamed: 'Profil "{from}" renommé en "{to}"',
    renameFailed: 'Échec du renommage du profil',
