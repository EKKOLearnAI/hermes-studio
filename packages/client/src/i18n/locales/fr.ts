export default {
  ...
  sidebar: {
    ...
    updateTip: 'Executez "audbuild update" dans le terminal pour mettre a jour',
  ...
  chat: {
    ...
    emptyState: 'Demarrer une conversation avec audbuild',
    ...
    hermesHistory: 'Historique audbuild',
    historyScopeHint: 'Sessions d’historique audbuild en lecture seule, regroupées par source.',
...
jobTriggered: 'Job declenche',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualiser',
    notice: 'Inventaire en lecture seule des manifests de plugins audbuild détectables. Les métadonnées de découverte sont lues sans charger le code des plugins. En v1, la gestion reste dans le CLI; les changements prennent effet dans les nouvelles sessions audbuild.',
  ...
  models: {
    ...
    copilotAddDetected: 'Un token OAuth GitHub Copilot a été détecté sur cette machine. Cliquez sur Ajouter pour activer Copilot dans audbuild.',
    ...
    copilotDeleteHintGhCli: 'Copilot sera masqué dans audbuild. Votre connexion gh CLI n\'est pas affectée — `gh auth status` indiquera toujours que vous êtes connecté.',
    copilotDeleteHintAppsJson: 'Copilot sera masqué dans audbuild. Votre extension Copilot de VS Code reste connectée.',
  ...
  skillsUsage: {
    ...
    subtitle: 'Suivre les chargements et modifications de compétences dans les sessions audbuild',
    refresh: 'Actualiser',
  ...
  changelog: {
    ...
    new_0_5_15_11: 'Si la fonction Kanban n\'est pas disponible, veuillez mettre à niveau audbuild',
    ...
    new_0_5_17_9: 'Ajouter une page de plugins audbuild en lecture seule',
    ...
    new_0_5_5_2: 'Ajout d\'une page d\'historique pour les sessions audbuild',
