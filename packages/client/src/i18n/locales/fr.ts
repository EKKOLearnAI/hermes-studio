...
jobTriggered: 'Job declenche',
  ...
  profiles: {
    ...
    thinkingAnimation: {
      title: 'Animation de réflexion personnalisée',
      customize: 'Animation',
      upload: 'Télécharger un fichier',
      save: 'Enregistrer',
      reset: 'Utiliser la valeur par défaut',
      hint: 'GIF, WebP, MP4 ou WebM. Max 5 Mo.',
      invalidType: "Veuillez choisir un fichier GIF, WebP, MP4, WebM ou image",
      tooLarge: "Le fichier d'animation doit faire 5 Mo ou moins",
      saveSuccess: 'Animation de réflexion enregistrée',
      saveFailed: "Échec de l'enregistrement de l'animation",
      resetSuccess: 'Animation par défaut restaurée',
      resetFailed: 'Échec de la restauration',
      urlPlaceholder: "Coller l'URL ou laisser vide pour la valeur par défaut",
      noPreview: 'Aucune animation personnalisée',
      enableThinking: "Activer l'animation de réflexion",
      delete: "Supprimer l'animation",
      maxReached: 'Maximum de {max} animations atteint',
      savedItems: '{count} animation(s) sauvegardée(s)',
    },
    runtime: {
