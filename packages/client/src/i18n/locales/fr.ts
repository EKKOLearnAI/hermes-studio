export default {
  ...
  login: {
    ...
    tokenLogin: 'Jeton',
    feishuLogin: 'Se connecter avec Feishu',
  ...
  sidebar: {
    ...
    feishuConnected: 'Feishu connecte',
    feishuNotConnected: 'Feishu non connecte',
    feishuChecking: 'Verification de la connexion Feishu',
    feishuConnecting: 'Connexion a Feishu',
    feishuConnectFailed: 'Echec de la connexion Feishu',
  ...
  chat: {
    ...
    loadSessionsFailed: 'Echec du chargement des sessions',
    retrySessions: 'Reessayer',
    exitBatchMode: 'Quitter le mode par lots',
    tooManySessionsInGroup: 'Affichage de {shown} sur {total} — utilisez la recherche pour les conversations plus anciennes',
    historyEmptyTitle: 'Aucun historique pour ce profil',
    historyEmptyHint: 'Les sessions du profil Hermes lié à cette connexion apparaîtront ici lorsque CLI, Feishu ou d’autres canaux créeront des enregistrements.',
