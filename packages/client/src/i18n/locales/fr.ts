export default {
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimationHint: 'Personnaliser l'animation affichée pendant le traitement de l'IA',
      taCustomLoaded: 'Animation personnalisée chargée',
      taDefault: 'Utilisation de l'animation par défaut',
      taChange: 'Changer',
      taUpload: 'Télécharger',
      taResetDefault: 'Réinitialiser par défaut',
      taHelp: 'Prend en charge GIF, MP4, WebM. MOV/AVI/MKV sont automatiquement convertis en MP4. Max 100Mo.',
      taFileTooLarge: 'Fichier trop volumineux (max 100Mo)',
      taUploadFailed: 'Échec du téléchargement',
      taResetFailed: 'Échec de la réinitialisation',
      theme: 'Theme',
