...
jobTriggered: 'Job declenche',
  ...
  settings: {
    ...
    voice: {
      ...
      clearStoredKey: 'Effacer la cle stockee',
      storedServerKey: 'Cle serveur stockee : {value}',
      secretPendingSave: 'sera mise a jour a l’enregistrement',
      storedOnServer: 'Stocke sur le serveur',
      saveTtsSettings: 'Enregistrer les reglages TTS',
      webspeechSettingsSaved: 'Reglages WebSpeech enregistres localement.',
      ttsSettingsSaved: 'Reglages TTS enregistres sur le serveur.',
      ttsSettingsSaveFailed: 'Echec de l’enregistrement des reglages TTS.',
      storedSecretCleared: 'Secret TTS stocke efface du serveur.',
      storedSecretClearFailed: 'Echec de l’effacement du secret TTS stocke.',
      mimoCloneAudioInvalid: 'L’audio de clonage MiMo doit etre un fichier mp3 ou wav.',
      mimoCloneAudioTooLarge: 'L’audio de clonage MiMo doit faire 10 Mo ou moins.',
      mimoCloneAudioReadFailed: 'Impossible de lire le fichier audio.',
      mimoCloneAudioCleared: 'Audio de clonage MiMo stocke efface du serveur.',
      mimoCloneAudioClearFailed: 'Echec de l’effacement de l’audio de clonage MiMo stocke.',
