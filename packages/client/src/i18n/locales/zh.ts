export default {
  ...
  settings: {
    ...
    display: {
      ...
      thinkingAnimationHint: '自定义 AI 处理时显示的动画',
      taCustomLoaded: '已加载自定义动画',
      taDefault: '使用默认动画',
      taChange: '更换',
      taUpload: '上传动画',
      taResetDefault: '恢复默认',
      taUploadReq: '上传要求',
      taFormat: '格式：GIF、MP4、WebM、MOV、AVI、MKV',
      taSize: '大小：≤ 20MB',
      taDuration: '时长：任意（自动裁剪至3秒）',
      taResolution: '分辨率：任意',
      taConvertHint: '非 MP4/GIF 格式将通过 ffmpeg 自动转换',
      taFileTooLarge: '文件过大（最大 20MB）',
      taUploadFailed: '上传失败',
      taResetFailed: '重置失败',
      theme: '主题',
  ...
  changelog: {
    ...
    new_0_4_3_1: '新增跨机器配置文件支持与 BFF 代理路由',
    new_0_4_3_2: '新增会话搜索功能',
    new_0_4_3_3: '新增上下文使用量追踪和 Token 显示',
    new_0_4_3_4: '新增基于提供商的上下文长度查询',
    new_0_4_1_1: 'Hermes Web UI 首次发布，支持聊天、模型和会话管理',
  },
  // Gateway Tabs
  gatewayTabs: {
    cannotDeleteActive: '不能删除当前活跃的配置',
    created: '已创建配置 "{name}"',
    createFailed: '创建配置失败',
    createTitle: '创建配置',
    delete: '删除',
