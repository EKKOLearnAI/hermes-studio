export default {
  ...
  sidebar: {
    ...
    feishuNotConnected: '飞书未连接',
    feishuChecking: '正在检查飞书连接',
    feishuConnecting: '正在连接飞书',
    feishuConnectFailed: '飞书连接失败',
    collapse: '收起菜单',
    expand: '展开菜单',
  ...
  chat: {
    ...
    tooManySessionsInGroup: '显示前 {shown} 条（共 {total} 条），更早的请使用搜索',
    historyEmptyTitle: '当前 Profile 暂无历史',
    historyEmptyHint: '这里会显示当前登录身份绑定的 Hermes 会话；CLI、飞书等通道产生新记录后会出现在这里。',
    searchTitle: '搜索会话',
  ...
  jobs: {
    ...
    gatewayUnavailable: '任务服务连接中',
    gatewayUnavailableHint: '任务列表暂时不可用。系统正在连接当前 profile 的任务服务，请稍后重试。',
    name: '名称',
  ...
  settings: {
    ...
    userMode: {
      title: '用户模式',
      description: '当前仅开放个人 Agent 的可用设置。账户、模型、频道、网关、日志和用户管理属于运维面，不能在这里查看或修改。',
    },
    display: {
      streaming: '流式响应',
      ...
      showTokenUsageHint: '在回复中显示本次会话的 token 使用量',
      inlineDiffs: '内联差异',
  ...
  groupChat: {
    title: '群聊',
    userModeTitle: '群聊 beta 暂未开放',
    userModeDescription: '当前用户模式先锁定个人 profile。群聊需要后端补齐房间归属、邀请范围和跨 profile Agent ACL 后再开放。',
    createRoom: '创建房间',
    joinByCode: '通过邀请码加入',
    roomName: '房间名称',
    ...
    clearContextConfirm: '清空这个房间的消息和压缩上下文？成员、智能体和配置会保留。',
  ...
  usage: {
    ...
    noData: '暂无用量数据',
    noDataTitle: '暂无用量数据',
    noDataHint: '当前 profile 还没有可统计的会话用量。',
  },
  // 文件管理
  files: {
    title: '文件',
    workspaceScope: 'Profile 工作区',
    workspaceFolders: '{count} 个文件夹',
    workspaceFiles: '{count} 个文件',
    workspaceCurrentPath: '当前位置：{path}',
    fileTree: '文件树',
    tree: '目录树',
    list: '文件列表',
    breadcrumbRoot: '根目录',
