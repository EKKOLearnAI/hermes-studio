export default {
  ...
  models: {
    ...
    copilotLoginIntro: 'Hermes Web UI 通过本机 gh CLI 复用 GitHub 认证。登录一次后即可持续使用。',
    copilotStep1: '请确认本机已安装 GitHub CLI（gh）。',
    copilotStep2: '在系统终端运行以下命令：',
    copilotStep3: '完成浏览器授权后，点击下方"刷新检测"。',
    copilotLoginNote: '授权由本机 gh CLI 持久化，重启 Web UI 后仍然有效。',
    copilotCopied: '命令已复制',
    copilotDetected: '已检测到 GitHub Copilot，可以使用。',
    copilotNotDetected: '尚未检测到 Copilot 授权，请确认 gh auth login 已完成。',
    copilotRefresh: '刷新检测',
    customBadge: '自定义',
    previewBadge: '预览',
    disabledBadge: '不可用',
