export default {
  ...
  runtimeVersions: {
    ...
    runtimeDirectoryHint: '下次重启时会在本地服务启动前复制并校验当前 Runtime，旧目录会保留。',
    runtimeDirectorySaved: 'Runtime 迁移已安排，重启 Hermes Studio 后执行。',
    runtimeMigrationPending: '待迁移到：{directory}',
    runtimeMigrationFailed: 'Runtime 迁移失败，已继续使用原 Runtime',
    active: '已启用',
    installed: '已安装',
    download: '下载',
  ...
  changelog: {
    ...
    new_0_6_31_12: '版本管理现在可以迁移 Runtime 存储目录；下次重启时会在服务启动前完成复制校验，并保留旧副本作为回退（#2134）',
