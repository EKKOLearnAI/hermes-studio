export default {
  ...
  models: {
    ...
    codexSelectAccount: '选择 Codex 账号',
    codexSwitchAccount: '切换账号',
    codexDeleteAccount: '删除账号',
    codexStatusLoadFailed: '加载 Codex 状态失败',
    ...
    codexManageTitle: 'Codex 账号管理',
    codexManageDesc: '支持浏览器设备码登录新增账号，并可切换/删除账号。',
    codexAddAccount: '新增账号（Codex 登录）',
    codexNoAccounts: '暂无 Codex 账号，点击“新增账号”开始。',
    codexActiveAccount: '当前账号：',
    codexActive: '当前使用',
    codexSwitch: '切换',
    codexSwitchSuccess: '账号已切换',
    codexSwitchFailed: '切换账号失败',
    codexDeleteTitle: '删除账号',
    codexDeleteConfirm: '确定删除账号 "{name}" 吗？',
    codexDeleteSuccess: '账号已删除',
    codexDeleteFailed: '删除账号失败',
    codexLoadFailed: '加载 Codex 状态失败',
    codexLoginFailed: 'Codex 登录启动失败',
    codexPollFailed: '轮询登录状态失败',
    codexNotEnabledHint: '首次登录成功后会显示 Codex Provider。',
  ...
  tunnels: {
    title: '隧道',
    subtitle: '通过 Cloudflare Quick Tunnel 临时暴露本地服务到公网。',
    tip: '使用 Cloudflare Quick Tunnel。每次重启可能会生成新的公开地址。',
    quickTunnel: '临时隧道',
    quickTunnelDesc: '通过 Cloudflare Quick Tunnel 临时暴露本地服务',
    running: '运行中',
    stopped: '已停止',
    targetUrl: '本地目标地址',
    targetPlaceholder: '例如 http://127.0.0.1:8650',
    publicUrl: '公网地址',
    noPublicUrl: '尚未生成，请先启动隧道。',
    generating: '正在生成公网地址，请稍候…',
    restart: '重启隧道',
    loadFailed: '加载隧道状态失败',
    startSuccess: '隧道已启动',
    startFailed: '隧道启动失败',
