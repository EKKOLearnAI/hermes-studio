export default {
  ...
  groupChat: {
    ...
    triggerTokensDesc: 'Room 上限；系统会根据每个参与者的模型上下文窗口自动采用更低的安全阈值',
    maxHistoryTokens: '最大历史 Token 数',
    maxHistoryTokensDesc: '压缩后历史的上限；系统会随参与者的有效触发阈值自动降低',
    ...
    roomSettings: '房间设置',
    handoffMode: '接力模式',
    handoffModeMentions: '按 Agent 输出提及',
    ...
    handoffRunning: '接力运行中',
    handoffFailed: '接力失败',
    handoffInterrupted: '接力已中断',
    activityDock: '当前活动',
    activityStep: '第 {step}/{total} 步',
    viewHandoffProgress: '查看进度',
    stopHandoff: '停止整条接力',
    stopReply: '停止 {agent} 当前回复',
