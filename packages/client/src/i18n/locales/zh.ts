export default {
  ...
  settings: {
    ...
    voice: {
      ...
      clearStoredKey: '清除已保存 key',
      storedServerKey: '服务端已保存 key：{value}',
      secretPendingSave: '保存时更新',
      storedOnServer: '已保存在服务端',
      saveTtsSettings: '保存 TTS 设置',
      webspeechSettingsSaved: 'WebSpeech 设置已保存到本地。',
      ttsSettingsSaved: 'TTS 设置已保存到服务端。',
      ttsSettingsSaveFailed: '保存 TTS 设置失败。',
      storedSecretCleared: '服务端 TTS secret 已清除。',
      storedSecretClearFailed: '清除服务端 TTS secret 失败。',
      mimoCloneAudioInvalid: 'MiMo 复刻音频必须是 mp3 或 wav 文件。',
      mimoCloneAudioTooLarge: 'MiMo 复刻音频不能超过 10 MB。',
      mimoCloneAudioReadFailed: '读取音频文件失败。',
      mimoCloneAudioCleared: '服务端 MiMo 复刻音频已清除。',
      mimoCloneAudioClearFailed: '清除服务端 MiMo 复刻音频失败。',
