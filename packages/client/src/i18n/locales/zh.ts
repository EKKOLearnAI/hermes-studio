...
export default {
  ...
  personalOS: {
    ...
    quickLog: '快速记录',
    quickLogPlaceholder: '一句话记录饮食、训练、皮肤或状态',
    quickLogSubmit: '记录',
    quickLogSaved: '已记录',
    quickLogFailed: '记录失败',
    weixinReminders: '微信提醒',
    weixinReminderOn: '已开启',
    weixinReminderOff: '未开启',
    weixinReminderSummary: '只推送当前最该做的一件事，遵守免打扰、去重和日限。',
    weixinReminderEnabled: '微信提醒已开启',
    weixinReminderDisabled: '微信提醒已关闭',
    weixinReminderUpdateFailed: '微信提醒更新失败',
    weixinReminderTest: '测试发送',
    weixinReminderTestSent: '测试提醒已发送',
    weixinReminderTestFailed: '测试提醒失败',
    quietHours: '免打扰',
    dailyLimit: '日限',
    lastReminder: '最近记录',
    openFullPlan: '查看完整计划',
    ...
    systems: {
      kicker: '完整系统',
      title: '深入管理入口',
      summary: '微信只负责轻交互，完整的计划、健身、饮食、皮肤和健康数据仍在系统内维护。',
      planning: {
        title: '计划系统',
        summary: '维护长期目标、日程和今日动作。',
      },
      fitness: {
        title: '健身系统',
        summary: '训练安排、记录、肌群体态和恢复。',
      },
      diet: {
        title: '饮食系统',
        summary: '营养缺口、食物记录和补剂执行。',
      },
      skin: {
        title: '皮肤系统',
        summary: '皮肤状态、护肤执行和触发因素。',
      },
      health: {
        title: '健康数据',
    ...
    checkIn: '打卡',
    noPending: '暂无待审核提案',
    noTasks: '暂无 Personal State 任务',
    noProposals: '暂无提案',
    emptyMemory: '还没有记录 Personal State。',
    loadFailed: '加载 Personal State 失败',
    approved: '提案已批准',
    rejected: '提案已拒绝',
    reviewFailed: '审核失败',
    taskCheckedIn: '任务已打卡',
  ...
  health: {
    ...
    scaleSync: {
      title: '体脂秤同步',
      settingsTitle: '小米健康 / 米家体脂秤',
      settingsSummary: '用于从米家或小米运动健康自动同步 S400 体脂秤数据。',
      enabled: '启用同步',
      enabledHint: '默认开启。未配置完整时系统会等待接入，不影响健康页使用。',
      source: '数据来源',
      sourceHint: 'S400 国行优先使用米家，中国大陆区域默认为 cn。',
      username: '小米账号',
      usernameHint: '用于读取你自己的体脂秤数据，只保存在本机 Hermes profile。',
      password: '小米密码',
      passwordHint: '保存后不会在前端回显明文。',
      passwordConfigured: '已保存密码；留空保存时会继续沿用旧密码。',
      region: '区域',
      regionHint: '中国大陆使用 cn。',
      scaleModel: '设备型号',
      scaleModelHint: '米家 S400 当前识别为 yunmai.scales.ms103。',
      path: '同步执行器路径',
      executor: '同步执行器',
      executorHint: '通常由 Hermes 自动安装或发现。只有自动发现失败时才需要手动指定 scaleconnect.exe。',
      runNow: '立即同步',
      openVerification: '打开小米验证',
      ready: '已配置',
      notReady: '未配置完整',
      synced: '已导入',
      healthReadySummary: '系统会自动尝试同步体脂秤数据；你也可以手动触发一次。',
      healthNotReadySummary: '系统默认会同步，但还缺少账号、密码或本机同步执行器。请到设置的接入页完成配置。',
      loadFailed: '加载体脂秤同步配置失败',
      saveFailed: '保存体脂秤同步配置失败',
      runFailed: '执行体脂秤同步失败',
      reason: {
        disabled: '同步未启用',
        missing_xiaomi_credentials: '缺少小米账号或密码',
        missing_scaleconnect_path: '缺少 SmartScaleConnect 路径',
        scaleconnect_not_found: '找不到 SmartScaleConnect',
        scaleconnect_failed: 'SmartScaleConnect 执行失败',
        scaleconnect_load_data_failed: '体脂秤数据读取失败',
        xiaomi_identity_verification_required: '需要完成小米账号身份验证',
      },
    },
    tabs: {
      overview: '概览',
    ...
    loop: {
      ...
      domains: {
        ...
        fitness: '健身',
        sleep: '睡眠',
        internal_health: '内在健康',
      },
      freshness: { current: '数据最新', missing: '等待数据', unavailable: '无接入源' },
      connectors: { errors: '接入源错误' },
      interventions: {
        title: '当前干预',
        activeCount: '{count} 项执行中',
        empty: '暂无执行中的干预，Hermes 将保持观察模式。',
        riskAuthority: '风险：{risk} · 权限：{authority}',
        categories: { training: '训练', recovery: '恢复', nutrition: '营养', posture: '体态', skin: '皮肤', internal_health: '内在健康' },
      },
      workflow: {
        draft: '草稿', policy_check: '策略检查', preparing: '准备中', executing: '执行中', verifying: '验证中',
        waiting_user: '等待确认', retrying: '重试中', compensating: '回滚中', succeeded: '已完成',
        denied: '已拒绝', cancelled: '已取消', failed: '失败', dead_letter: '需要人工处理', compensated: '已回滚',
        confirmationRequired: '此工作流需要你的明确确认。',
        actions: { approve: '批准', reject: '拒绝', cancel: '取消', retry: '重试', compensate: '撤销' },
      },
      feedback: { title: '结果反馈', completed: '已完成', partial: '部分完成', deferred: '稍后处理', adverse_feedback: '出现不良反应' },
      capture: {
        title: '采集与复核',
        localFirst: '本地优先',
        requirementFormat: '支持图片、PDF、JSON、CSV 或文本导出。',
        requirementPrivacy: '仅把你复核过的提取值用于分析。',
        requirementReview: '授权前逐项检查所有提取值。',
        fileLabel: '选择健康资料',
        processorLabel: '处理器',
        selectProcessor: '选择处理器',
        extractedValues: '提取值复核',
        noExtractedValues: '采集后将在这里显示待复核的提取值。',
        continue: '上传并复核',
        uploading: '上传中…',
      },
      consent: {
        title: '复核分析授权',
        oneTime: '一次性授权清单',
        summary: '本次授权仅适用于列出的资料、字段、目的、处理器和保留策略。',
        processor: '处理器', purpose: '用途', artifacts: '资料', regions: '区域', fields: '字段', retention: '保留策略',
        confirm: '仅授权本次并分析', processing: '分析中…',
      },
      automation: {
        title: '健康自动化',
        summary: '影子模式只评估投递，不会真实发送微信消息。',
        shadow: '影子模式', live: '实时模式',
        confirmationLabel: '输入 {code} 才能启用微信实时投递。',
        liveWeixin: '启用微信实时投递',
        returnShadow: '返回影子模式',
      },
      errors: { actionFailed: '健康动作执行失败' },
    },
  },

  fitness: {
    title: '健身系统',
    subtitle: '把训练计划、训练记录、肌群体态和恢复状态作为完整系统管理。',
    todayFocus: '今日训练重点',
    todayFocusFallback: '暂无今日训练说明，先查看训练记录和恢复状态。',
    plannedWorkouts: '计划训练',
    recentLogs: '近期记录',
    bodyFocus: '肌群关注',
    workout: '训练',
    planned: '已计划',
    ...
    energy: '精力',
    pain: '疼痛',
    noTodayWorkout: '暂无今日训练安排',
    noWorkoutLogs: '暂无训练记录',
    noBodyFocus: '暂无肌群或体态关注点',
    noRecoveryNote: '暂无恢复备注',
    loadFailed: '加载健身系统失败',
    tabs: {
      today: '今日训练',
      plan: '训练计划',
  ...
  devices: {
    ...
    unblock: '解除拉黑',
    healthDevice: {
      summary: '从米家云端同步到 Hermes 的体脂秤原始数据视图。',
      connected: '已接入',
      notConfigured: '未完成接入',
      loading: '正在加载体脂秤数据',
      noData: '暂无体脂秤数据',
