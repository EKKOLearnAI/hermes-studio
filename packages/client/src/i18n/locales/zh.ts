...
export default {
  ...
  agentManager: {
    ...
    cursorNoManagedConfig: 'Cursor 的 MCP 服务写在 ~/.cursor/mcp.json。请在 MCP 面板里编辑。CLI 没有 --mcp-config，所以 Studio 会把托管服务合并进该文件。',
  ...
  connections: {
    ...
    app: {
      ...
      pushNotifications: "消息推送",
      pushForDevice: "向 {name} 推送通知",
      pushUpdateFailed: "更新推送设置失败",
      online: '在线',
      offline: '离线',
      active: '有效',
      expired: '已过期',
