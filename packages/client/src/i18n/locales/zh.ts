export default {
  ...
  models: {
    ...
    copilotDeleteHintGhCli: 'Copilot 将从 QuantHermes 列表移除。不会影响 gh CLI —— `gh auth status` 仍显示已登录。',
    copilotDeleteHintAppsJson: 'Copilot 将从 QuantHermes 列表移除。不会影响 VS Code Copilot 插件的登录。',
    customBadge: '自定义',
    previewBadge: '预览',
    disabledBadge: '不可用',
  ...
  changelog: {
    ...
    new_0_6_0_7: '新增 CLI 维护命令，用于清理登录 IP 锁和重置默认 quanthermes / 12345678 登录账户',
