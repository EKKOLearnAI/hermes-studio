...
export default {
  dshPlugins: {
    ...
    "noEntries": "没有插件条目",
    "conditional": "按条件启用",
    "additionalPackages": "额外安装的 ACP 软件包",
    "title": "插件管理",
    "packages": "软件包",
    "install": "安装",
    "update": "更新",
    ...
    "succeeded": "成功",
    "failed": "失败",
    "description": "Studio 管理的原生 ACP 插件用于各会话后续的 DSH 启动，运行中的进程继续使用原版本。暂不支持浏览器端插件。",
    "installHint": "请输入 包名{'@'}精确版本。安装脚本不会执行，新插件组合需手动启用。仅安装可信软件包。",
    "removeConfirm": "从后续启动中卸载 {name}？",
    "runtimeUnknown": "这里只显示配置状态，尚未验证运行健康状态和兼容性。",
    "entries": "声明的插件条目",
    "discard": "放弃草稿并加载最新已保存配置？",
    "configHint": "YAML 补丁在已启用的插件组合之后应用，下次启动 DSH 时生效。",
    "rollbackConfirm": "后续启动使用此保留版本？",
    "conflict": "配置已被其他操作修改。草稿已保留，请对比最新版本后重新加载。",
    "missingDependency": "请先安装 DSH 和 pnpm。",
    "busy": "有操作正在进行，或请求的软件包状态冲突。请刷新后重试。",
    "interrupted": "操作中断，仍保留此前的有效版本。",
    "unsupported": "原生 ACP 管理暂不支持此软件包或能力。",
    "invalid": "请检查软件包精确版本或 YAML 补丁序列。",
    "timeout": "操作超时，仍保留此前的有效版本。"
},
