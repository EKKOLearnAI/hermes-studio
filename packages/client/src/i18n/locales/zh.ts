...
export default {
  ...
  petdex: {
    ...
    local: {
      ...
      importTitle: '导入本地宠物',
      empty: '还没有导入本地宠物。',
      emptyLocal: '本地宠物为空，点击右上角「导入」添加你的第一只宠物。',
      emptyInstalled: '还没有已安装的宠物。领取 Petdex 上的宠物后会自动出现在这里。',
      loadFailed: '加载本地宠物失败',
      imported: '已导入 {name}',
      importFailed: '导入宠物失败',
      spritesheetRequired: '请选择精灵图文件',
      displayName: '名称',
      displayNamePlaceholder: '宠物名称',
      kind: '类型',
      submittedBy: '作者',
      submittedByPlaceholder: '作者名称',
      spritesheet: '精灵图',
      chooseSpritesheet: '选择精灵图文件',
      petJson: 'pet.json（可选）',
      choosePetJson: '选择 pet.json',
      cancel: '取消',
      confirm: '导入',
      searchPlaceholder: '按名称、slug 或作者搜索',
      source: {
        local: '本地导入',
        petdex: '已下载',
      },
      refresh: '刷新',
      autoFilled: '已从 {source} 自动识别并填充元数据',
      petJsonInvalid: 'pet.json 不是合法的 JSON 文件',
      remove: '删除',
      removeTitle: '删除本地宠物',
      removeConfirm: '确定要删除「{name}」吗？此操作会移除已下载的精灵图文件，且不可恢复。',
      removed: '已删除 {name}',
      removeFailed: '删除宠物失败',
      dropTitle: '上传宠物包',
      dropHint: '拖入包含 pet.json 和精灵图集文件 spritesheet.webp（或 .png）的文件夹。推荐 1536×1872，8×9 帧网格。',
      pickFolder: '选择文件夹',
      pickZip: '选择 zip',
      pickSpritesheet: '选择精灵图集',
      dropNote: '在你确认前，包会一直保留在本地。',
      reviewTitle: '提交检查',
      reviewEmpty: '在你确认前，包会一直保留在本地。请选择精灵图集或文件夹。',
      reviewReady: '可以提交了。',
      spriteLoaded: '已选择精灵图：{name}',
      folderMissingSprite: '所选文件夹中没有 spritesheet.* 文件。',
    },
  },
  ...
  settings: {
    ...
    voice: {
      ...
      doubaoCloneVoiceHint: '输入格式：音色ID,音色名称；可保存多个语音克隆音色。',
      doubaoCloneVoicePlaceholder: '例如：S_xxxxx,我的声音',
      doubaoCloneVoiceFormatError: '请输入“音色ID,音色名称”格式。',
      apiKey: 'API key',
