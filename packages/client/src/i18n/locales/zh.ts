export default {
  ...
  models: {
    ...
    geminiLoginTitle: 'Google Gemini 登录',
    geminiWaiting: '请在打开的 Google 页面完成授权。授权完成后窗口会自动关闭。',
    geminiPolicyNotice: '此处使用 Gemini CLI / Cloud Code Assist OAuth。若需最低风险的官方路径，请使用带 GOOGLE_API_KEY 的 Google AI Studio。',
    geminiOpenLink: '打开 Google 授权页',
    geminiCopyLink: '复制授权链接',
    geminiApproved: '登录成功',
    geminiExpired: '授权已过期，请重试。',
