...
ttsProtectedRoutes.get('/api/studio/tts/speech-preprocessing', ctrl.getSpeechPreprocessing)
ttsProtectedRoutes.put('/api/studio/tts/speech-preprocessing', ctrl.updateSpeechPreprocessing)
ttsProtectedRoutes.get('/api/studio/tts/fallback', ctrl.getTtsFallback)
ttsProtectedRoutes.put('/api/studio/tts/fallback', ctrl.updateTtsFallback)
ttsProtectedRoutes.post('/api/studio/tts/prepare', ctrl.prepareSpeechPreview)
ttsProtectedRoutes.get('/api/studio/voice/usage', ctrl.getVoiceUsage)
