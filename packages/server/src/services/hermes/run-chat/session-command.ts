  ...
  switch (command.name) {
    case 'usage': {
      ...
      if (bu) {
        ...
        const contextForDisplay = (bu.lastPromptTokens != null && bu.lastPromptTokens > 0)
          ? bu.lastPromptTokens
          : bu.promptTokens || bu.inputTokens || state.contextTokens || (localUsage.inputTokens + localUsage.outputTokens)
