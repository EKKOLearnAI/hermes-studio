...
const translations: Record<DesktopLocale, Record<TranslationKey, string>> = {
  en: {
    ...
    'runtime.migrating': 'Copying Hermes runtime to the selected storage directory...',
  ...
  zh: {
    ...
    'runtime.migrating': '正在将 Hermes 运行时迁移到所选存储目录...',
  ...
  'zh-TW': {
    ...
    'runtime.migrating': '正在將 Hermes 運行時遷移至所選儲存目錄...',
  ...
  ja: {
    ...
    'runtime.migrating': 'Hermes ランタイムを選択した保存先へ移行しています...',
  ...
  ko: {
    ...
    'runtime.migrating': 'Hermes 런타임을 선택한 저장 디렉터리로 이동하는 중...',
  ...
  fr: {
    ...
    'runtime.migrating': 'Migration du runtime Hermes vers le repertoire selectionne...',
  ...
  es: {
    ...
    'runtime.migrating': 'Moviendo el runtime de Hermes al directorio seleccionado...',
  ...
  de: {
    ...
    'runtime.migrating': 'Hermes Runtime wird in das ausgewahlte Speicherverzeichnis verschoben...',
  ...
  pt: {
    ...
    'runtime.migrating': 'Movendo o runtime Hermes para o diretorio selecionado...',
