...
type TranslationKey =
  ...
  | 'update.downloading'
  | 'update.progressTitle'
  | 'update.preparingDownload'
  | 'update.downloadFailed'
  | 'update.downloadFailedHint'
  | 'update.downloadBackgroundHint'
  | 'update.readyTitle'
  | 'update.readyMessage'
  | 'update.readyDetail'
  | 'update.restartNow'
...
const translations: Record<DesktopLocale, Record<TranslationKey, string>> = {
  en: {
    ...
    "update.progressTitle": "Software update",
    "update.preparingDownload": "Preparing download…",
    "update.downloadFailed": "Download failed",
    "update.downloadFailedHint": "Check your connection, then check for updates again from the tray menu.",
    "update.downloadBackgroundHint": "You can keep working. Closing this window does not cancel the download.",
  ...
  zh: {
    ...
    "update.progressTitle": "软件更新",
    "update.preparingDownload": "正在准备下载…",
    "update.downloadFailed": "更新下载失败",
    "update.downloadFailedHint": "请检查网络，然后从托盘菜单重新检查更新。",
    "update.downloadBackgroundHint": "你可以继续使用应用。关闭此窗口不会取消下载。",
  ...
  'zh-TW': {
    ...
    "update.progressTitle": "軟體更新",
    "update.preparingDownload": "正在準備下載…",
    "update.downloadFailed": "更新下載失敗",
    "update.downloadFailedHint": "請檢查網路，再從系統匣選單重新檢查更新。",
    "update.downloadBackgroundHint": "你可以繼續使用應用程式，關閉此視窗不會取消下載。",
  ...
  ja: {
    ...
    "update.progressTitle": "ソフトウェア更新",
    "update.preparingDownload": "ダウンロード準備中…",
    "update.downloadFailed": "ダウンロード失敗",
    "update.downloadFailedHint": "接続を確認し、トレイメニューから更新を再確認してください。",
    "update.downloadBackgroundHint": "アプリは引き続き使えます。このウィンドウを閉じてもダウンロードは続きます。",
  ...
  ko: {
    ...
    "update.progressTitle": "소프트웨어 업데이트",
    "update.preparingDownload": "다운로드 준비 중…",
    "update.downloadFailed": "다운로드 실패",
    "update.downloadFailedHint": "연결을 확인한 후 트레이 메뉴에서 업데이트를 다시 확인하세요.",
    "update.downloadBackgroundHint": "계속 사용할 수 있습니다. 창을 닫아도 다운로드는 취소되지 않습니다.",
  ...
  fr: {
    ...
    "update.progressTitle": "Mise à jour",
    "update.preparingDownload": "Préparation du téléchargement…",
    "update.downloadFailed": "Échec du téléchargement",
    "update.downloadFailedHint": "Vérifiez la connexion puis recherchez les mises à jour depuis le menu de notification.",
    "update.downloadBackgroundHint": "Vous pouvez continuer à travailler. Fermer cette fenêtre ne coupe pas le téléchargement.",
  ...
  es: {
    ...
    "update.progressTitle": "Actualización",
    "update.preparingDownload": "Preparando descarga…",
    "update.downloadFailed": "Error de descarga",
    "update.downloadFailedHint": "Comprueba la conexión y vuelve a buscar actualizaciones desde la bandeja.",
    "update.downloadBackgroundHint": "Puedes seguir trabajando. Cerrar esta ventana no cancela la descarga.",
  ...
  de: {
    ...
    "update.progressTitle": "Softwareupdate",
    "update.preparingDownload": "Download wird vorbereitet…",
    "update.downloadFailed": "Download fehlgeschlagen",
    "update.downloadFailedHint": "Verbindung prüfen und im Tray-Menü erneut nach Updates suchen.",
    "update.downloadBackgroundHint": "Sie können weiterarbeiten. Das Schließen dieses Fensters bricht den Download nicht ab.",
  ...
  pt: {
    ...
    "update.progressTitle": "Atualização",
    "update.preparingDownload": "Preparando download…",
    "update.downloadFailed": "Falha no download",
    "update.downloadFailedHint": "Verifique a conexão e procure atualizações novamente no menu da bandeja.",
    "update.downloadBackgroundHint": "Pode continuar usando o aplicativo. Fechar esta janela não cancela o download.",
